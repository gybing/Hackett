...
public:
    ...
    TDChannel* getChanelByIdx(int n);
    const TDChannel* getCurrentChannel();
    void setChannelIdx(int idx);

    TDSong* getCurrentSong();
    TDSong* getLastSong();
    int getSongCount();
    bool removeLastSong();
    void removeSong(const String& ssid);
...
private:
    ...
    Array<AXDown*> arrDowns;
    struct TDChannel* currentChannel;
