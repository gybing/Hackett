...
class HorListBox  : public juce::Component,
                           public juce::SettableTooltipClient
{
public:
    HorListBox (const juce::String& componentName = juce::String::empty,
    ...
    */
    ...
    void setRowSelectionEnabled (bool b) noexcept;
    ...
    */
    ...
    /** Sets the rows that should be selected, based on an explicit set of ranges.
        ...
        If sendNotificationEventToModel is true, the juce::ListBoxModel::selectedRowsChanged()
    ...
    */
    ...
    /** Returns the current Horizontal position as a proportion of the total.

        This can be used in conjunction with setHorizontalPosition() to save and restore
        the list's position. It returns a value in the range 0 to 1.

        @see setHorizontalPosition
    */
    ...
    /** Finds the row index that contains a given x,y position.
        The position is relative to the HorListBox's top-left.
    ...
    */
    int getVisibleRowHeight() const noexcept;
    ...
    */
    ...
    /** Returns the height of a row in the list.
        @see setRowHeight
    */
    int getRowWidth() const noexcept                   { return rowWidth; }
    ...
    */
    ...
    /** Sets the thickness of a border that will be drawn around the box.
        ...
        To set the colour of the outline, use @code setColour (HorListBox::outlineColourId, colourXYZ); @endcode
        @see outlineColourId
    */
    ...
    */
    ...
    /** Returns the viewport that this HorListBox uses.
...
private:
    ...
    int totalItems, rowWidth, minimumRowHeigth;
    int outlineThickness;
    int lastRowSelected;
    bool multipleSelection, alwaysFlipSelection, hasDoneInitialUpdate, selectOnMouseDown, selectionEnabled;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (HorListBox)
};
