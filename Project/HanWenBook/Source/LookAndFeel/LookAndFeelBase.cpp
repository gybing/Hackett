...
{
    static juce::Colour createBaseColour (Colour buttonColour,
...
LookAndFeelBase::LookAndFeelBase()
{
    ...
    {
        TextButton::buttonColourId,                 0x00000000,
        TextButton::buttonOnColourId,               0x00000000,
        TextButton::textColourOnId,                 0xFFFFFFFF,
        TextButton::textColourOffId,                0xFF3E3A39,

        ToggleButton::textColourId,                 0xff000000,

        TextEditor::backgroundColourId,             0xffffffff,
        TextEditor::textColourId,                   0xff000000,
        TextEditor::highlightColourId,              0xff3399ff,
        TextEditor::highlightedTextColourId,        0xffffffff,
        TextEditor::outlineColourId,                0x00000000,
        TextEditor::focusedOutlineColourId,         0xffbbbbff,
        TextEditor::shadowColourId,                 0x00000000,
        ...
        ScrollBar::thumbColourId,                   0xffc3c8cb,
        ScrollBar::trackColourId,                   0xffdbe0e4,

        TreeView::linesColourId,                    0x4c000000,
        TreeView::backgroundColourId,               0x00000000,
        TreeView::dragAndDropIndicatorColourId,     0x80ff0000,
        TreeView::selectedItemBackgroundColourId,   0x301111ee,

        PopupMenu::backgroundColourId,              0xffffffff,
        PopupMenu::textColourId,                    0xFF3E3A39,
        PopupMenu::headerTextColourId,              0xFF3E3A39,
        PopupMenu::highlightedTextColourId,         0xFF3E3A39,
        PopupMenu::highlightedBackgroundColourId,   0xFFdcdcdc,

        ComboBox::buttonColourId,                   0xffeeeeff,
        ComboBox::outlineColourId,                  0xb2808080,
        ...
        TextPropertyComponent::outlineColourId,     0xb2808080,

        BooleanPropertyComponent::backgroundColourId, 0xffffffff,
        BooleanPropertyComponent::outlineColourId,  0xb2808080,

        ListBox::backgroundColourId,                0xffffffff,
        ListBox::outlineColourId,                   0xb2808080,
        ...
        Slider::textBoxHighlightColourId,           0x401111ee,
        Slider::textBoxOutlineColourId,             0xb2808080,
        Slider::trackColourId,                      0xbbffffff,
        Slider::thumbColourId,                      0xffddddff,

        ResizableWindow::backgroundColourId,        0xff777777,
        //DocumentWindow::textColourId,               0xff000000, // (this is deliberately not set)

        AlertWindow::backgroundColourId,            0xfff3f3f0,
        AlertWindow::textColourId,                  0xFF3E3A39,
        AlertWindow::outlineColourId,               0xFF59B2BA,
        ...
        TabbedComponent::outlineColourId,           0x66000000,
        TabbedButtonBar::tabOutlineColourId,        0x80000000,
        TabbedButtonBar::frontOutlineColourId,      0x90000000,

        Toolbar::backgroundColourId,                0xFF5D5D5D,
        Toolbar::separatorColourId,                 0xFF9a9a9a,
        Toolbar::buttonMouseOverBackgroundColourId, 0x00000000,
        Toolbar::buttonMouseDownBackgroundColourId, 0x00000000,
        Toolbar::labelTextColourId,                 0xFF9a9a9a,
        //Toolbar::labelTextOnColourId,               0xFFFFFFFF,
        Toolbar::editingModeOutlineColourId,        0xFF9a9a9a,

        DrawableButton::textColourId,               0xFF3E3A39,
        DrawableButton::textColourOnId,             0xFFFFFFFF,
        DrawableButton::backgroundColourId,         0x00000000,
        DrawableButton::backgroundOnColourId,       0x00000000,
        ...
        BubbleComponent::backgroundColourId,        0xeeeeeedd,
        BubbleComponent::outlineColourId,           0x77000000,

        DirectoryContentsDisplayComponent::highlightColourId,   0x401111ee,
        ...
        0x1004502, /*CodeEditorComponent::highlightColourId*/                 0x401111ee,
        ...
        TabbedButtonBar::tabOutlineColourId,                    0x66000000,

        CXDocumentWindow::textColourId,                         0xFFFFFFFF,
        ColorButton::buttonColourNormalId,                      0xFF59B2BA,
        ColorButton::buttonColourHoverId,                       0xFF4a979e,
        ColorButton::buttonColourDownId,                        0xFF1b8c96,
        ColorButton::textColourNormalId,                        0xFF59B2BA,
        ColorButton::textColourHoverId,                         0xFF4a979e,
        ColorButton::textColourDownId,                          0xFF1b8c96,
        ColorButton::buttonBackgroundId,                        0xFFF3F3F0,

        ToolButton::textColourId,                              0xFF9fa0a0,  /**< The colour to use for the button's text label. */
        ToolButton::textColourOnId,                            0xFFFFFFFF,  /**< The colour to use for the button's text.when the button's toggle state is "on". */
        ToolButton::backgroundColourId,                        0x00000000,  
        ToolButton::backgroundOnColourId,                      0x00000000,

        VerticalToolMenu::backgroundId,                         0xFF404040,

        EmojiComponent::backgroundColourId,                     0xFFFFFFFF,  /**< The colour to fill the menu's background with. */
        EmojiComponent::lineColourId,                           0xFFFFFFFF,
        EmojiComponent::highlineColourId,                       0xff0594c1
    };
...
void LookAndFeelBase::drawRoundThumb (Graphics& g, const float x, const float y,
...
void LookAndFeelBase::drawLinearSlider (Graphics& g, int x, int y, int width, int height,
...
void LookAndFeelBase::drawLinearSliderBackground (Graphics& g, int x, int y, int width, int height,
                                                  float /*sliderPos*/,
                                                  float /*minSliderPos*/,
                                                  float /*maxSliderPos*/,
                                                  const Slider::SliderStyle /*style*/, Slider& slider)
...
void LookAndFeelBase::drawCXDocumentWindowTitleBar (CXDocumentWindow& window, Graphics& g,
                                                    int w, int h, int titleSpaceX, int titleSpaceW,
                                                    const Image* icon, bool drawTitleTextOnLeft, Justification justification)
{
    ...
    if (icon != nullptr)
    {
        ...
        g.drawImageWithin (*icon, 5, (h - iconH) / 2, iconW, iconH,
    ...
    g.drawText (window.getTitle(), iconW + 5, 0, w - (2*iconW) - 10, h, justification, true);
}
//==============================================================================
class LookAndFeelBase::GlassWindowButton   : public Button
{
public:
    ...
    void paintButton (Graphics& g, bool isMouseOverButton, bool isButtonDown) override
    {
        ...
        float x = 0, y = 0;
        float diam = 18;//(getWidth() < getHeight()) ? ((float) getWidth() * 0.5f) : ((float) getHeight() * 0.5f);
...
Button* LookAndFeelBase::createCXDocumentWindowButton (int buttonType)
{
    Path shape;
    ...
    if (buttonType == CXDocumentWindow::closeButton)
    {
        ...
        return new LookAndFeelBase::GlassWindowButton ("close", Colour (0xffea5a4e), shape, shape);
    }
    ...
    if (buttonType == CXDocumentWindow::minimiseButton)
    {
        ...
        return new LookAndFeelBase::GlassWindowButton ("minimise", Colour (0xffaa8811), shape, shape);
    }
    ...
    if (buttonType == CXDocumentWindow::maximiseButton)
    {
        ...
        return new LookAndFeelBase::GlassWindowButton ("maximise", Colour (0xff119911), shape, fullscreenShape);
    }
...
void LookAndFeelBase::positionCXDocumentWindowButtons (CXDocumentWindow&,
...
void LookAndFeelBase::drawLinearSliderThumb (Graphics& g, int x, int y, int width, int height,
                                             float sliderPos, float minSliderPos, float maxSliderPos,
                                             const Slider::SliderStyle style, Slider& slider)
{
    ...
    else
    {
        ...
        LookAndFeelBase::drawLinearSliderThumb (g, x, y, width, height, sliderPos, minSliderPos, maxSliderPos, style, slider);
    }
}

void LookAndFeelBase::drawRotarySlider (Graphics& g, int x, int y, int width, int height, float sliderPos,
...
Font LookAndFeelBase::getTextButtonFont (TextButton&, int buttonHeight)
{
    return Font (buttonHeight * 0.9f);
}

int LookAndFeelBase::getTextButtonWidthToFitText (TextButton& b, int buttonHeight)
{
    return getTextButtonFont (b, buttonHeight).getStringWidth (b.getButtonText()) + buttonHeight;
}

void LookAndFeelBase::drawButtonText (Graphics& g, TextButton& button, bool isMouseOverButton, bool isButtonDown)
{
...
void LookAndFeelBase::drawTickBox (Graphics& g, Component& component,
                                   ...
                                   const bool isButtonDown)
{
    ...
    juce::Colour color = isEnabled ? (isButtonDown ? 
        juce::Colour(0xFFa0a0a0).contrasting(0.4f) : 
        (isMouseOverButton ? juce::Colour(0xFFa0a0a0).contrasting(0.2f) : 
        juce::Colour(0xFFa0a0a0))) : Colours::lightgrey.withAlpha (0.1f);

    const bool radio =  0 != ((ToggleButton&)component).getRadioGroupId();

    if (radio)
    {
        float boxSize = w * 0.9f;
        const float outlineThickness = isEnabled ? ((isButtonDown || isMouseOverButton) ? 1.1f : 0.5f) : 0.3f;
        drawGlassSphere (g, x + (h - boxSize) * 0.5f, y + (h - boxSize) * 0.5f, boxSize, color, outlineThickness);

        if (ticked)
        {
            if (boxSize <= outlineThickness)
                return;

             float size = boxSize * 0.7f;

             Path p;
             p.addEllipse (x + (h - size) * 0.5f, y + (h - size) * 0.5f, size, size);
             
             {
                 g.setColour(isEnabled ? juce::Colour(0xFF35c500) : Colours::grey);
                 g.fillPath (p);
             }
        }
    }
    ...
    {
        Path box;
        box.addRoundedRectangle (0.0f, 1.5f, 7.0f, 7.0f, 0.0f);
        ...
        {
            Path tick;
            tick.startNewSubPath (5.0f, 5.5f);
            tick.lineTo (8.0f, 0.0f);
            g.setColour (ProjectInfo::colorLightWhite);
            g.strokePath (tick, PathStrokeType (5.0f), trans);

            tick.clear();
            tick.startNewSubPath (1.5f, 3.5f);
            tick.lineTo (3.5f, 6.5f);
            tick.lineTo (8.0f, 0.0f);
            g.setColour (isEnabled ? juce::Colour(0xFF35c500) : Colours::grey);
...
void LookAndFeelBase::drawToggleButton (Graphics& g, ToggleButton& button,
                                        bool isMouseOverButton, bool isButtonDown)
{
    ...
    const String& txt = button.getButtonText();
    if (txt.isNotEmpty())
    {
...
void LookAndFeelBase::changeToggleButtonWidthToFitText (ToggleButton& button)
{
...
void LookAndFeelBase::drawDrawableButton (Graphics& g, DrawableButton& button,
                                          bool isMouseOverButton, bool isButtonDown)
{
    ...
    const int textH = (button.getStyle() == DrawableButton::ImageAboveTextLabel)
        ? button.proportionOfHeight (0.25f) : 0;

    if (textH > 0)
    {
        g.setFont ((float) textH);

        g.setColour (button.findColour (toggleState || isMouseOverButton || isButtonDown ? DrawableButton::textColourOnId
...
//==============================================================================
AlertWindow* LookAndFeelBase::createAlertWindow (const String& title, const String& message,
                                                 ...
                                                 int numButtons, Component* associatedComponent)
{
    ...
    if (numButtons == 1)
    {
        aw->addButton (true, Colour(0xFF0083B7), button1, 0,
    ...
    else
    {
        ...
        if (numButtons == 2)
        {
            aw->addButton (true, Colour(0xFF0083B7), button1, 1, KeyPress (KeyPress::returnKey), button1ShortCut);
            aw->addButton (true, Colour(0xFF0083B7), button2, 0, KeyPress (KeyPress::escapeKey), button2ShortCut);
        }
        else if (numButtons == 3)
        {
            aw->addButton (true, Colour(0xFF0083B7), button1, 1, button1ShortCut);
            aw->addButton (true, Colour(0xFF0083B7), button2, 2, button2ShortCut);
            aw->addButton (true, Colour(0xFF0083B7), button3, 0, KeyPress (KeyPress::escapeKey));
        }
    }
...
void LookAndFeelBase::drawAlertBox (Graphics& g, AlertWindow& alert, const Rectangle<int>& textArea, TextLayout& textLayout)
{
    g.fillAll (alert.findColour (AlertWindow::backgroundColourId));
    
    juce::Rectangle<int> area(textArea.getX() + 4, textArea.getY() + 35, textArea.getWidth() - 8, textArea.getHeight() - 39);

    g.setColour (alert.findColour (AlertWindow::outlineColourId));
    Path border;
    border.addRectangle(0, 0, alert.getWidth(), 35);
    border.addRectangle(0, 35, 4, alert.getHeight()-35);
    border.addRectangle(4, alert.getHeight()-4, alert.getWidth()-8, 4);
    border.addRectangle(alert.getWidth()-4, 35, 4, alert.getHeight()-35);
    border.closeSubPath();
    g.fillPath(border);

    g.setFont(getAlertWindowTitleFont());
    g.setColour(juce::Colours::white);
    g.drawFittedText(alert.getName(), 0, 0, alert.getWidth(), 35, juce::Justification::centred, 1);

    g.setColour (alert.findColour (AlertWindow::textColourId));
    textLayout.draw (g, Rectangle<int> (area.getX(),
        area.getY(),
        area.getWidth(),
        area.getHeight()).toFloat());
}
...
Font LookAndFeelBase::getAlertWindowTitleFont()
{
...
//==============================================================================
void LookAndFeelBase::drawProgressBar (Graphics& g, ProgressBar& progressBar,
...
void LookAndFeelBase::drawSpinningWaitAnimation (Graphics& g, const Colour& colour, int x, int y, int w, int h)
{
...
void LookAndFeelBase::drawScrollbarButton (Graphics& g, ScrollBar& scrollbar,
                                           int width, int height, int buttonDirection,
                                           bool /*isScrollbarVertical*/,
                                           bool isMouseOverButton,
                                           bool isButtonDown)
{
    if (isMouseOverButton = (scrollbar.isMouseOverOrDragging() || scrollbar.isMouseOver(true)))
    {
        Path p;
        ...
        if (isButtonDown)
            g.setColour (scrollbar.findColour (ScrollBar::thumbColourId).contrasting (0.3f));
        else
            g.setColour (scrollbar.findColour (ScrollBar::thumbColourId));

        g.setColour (isMouseOverButton && !isButtonDown ? 
            scrollbar.findColour(ScrollBar::thumbColourId).contrasting(0.3f) : 
            scrollbar.findColour (ScrollBar::thumbColourId).contrasting(0.1f));
        g.fillPath (p);
    }
}

void LookAndFeelBase::drawScrollbar (Graphics& g,
                                     ScrollBar& scrollbar,
                                     int x, int y,
                                     int width, int height,
                                     bool isScrollbarVertical,
                                     ...
                                     bool isMouseDown)
{
    ...
    if (isMouseOver = (scrollbar.isMouseOverOrDragging() || scrollbar.isMouseOver(true)))
    {
    ...
    g.setColour (isMouseOver && !isMouseDown ? thumbColour.contrasting(0.3f) : thumbColour.contrasting(0.1f));
...
//==============================================================================
Path LookAndFeelBase::getTickShape (const float height)
{
...
Path LookAndFeelBase::getCrossShape (const float height)
{
...
//==============================================================================
void LookAndFeelBase::drawTreeviewPlusMinusBox (Graphics& g, const Rectangle<float>& area,
...
bool LookAndFeelBase::areLinesDrawnForTreeView (TreeView&)
{
    return true;
}

int LookAndFeelBase::getTreeViewIndentSize (TreeView&)
{
    return 24;
}

//==============================================================================
void LookAndFeelBase::drawBubble (Graphics& g, BubbleComponent& comp,
...
void LookAndFeelBase::getIdealPopupMenuItemSize (const String& text, const bool isSeparator,
                                                 int standardMenuItemHeight, int& idealWidth, int& idealHeight)
{
    ...
    else
    {
        ...
        idealHeight = standardMenuItemHeight > 0 ? standardMenuItemHeight : roundToInt (font.getHeight() * 1.6f);
        idealWidth = juce::jmin(250, (int)(font.getStringWidth (text) + idealHeight));
    }
}
...
void LookAndFeelBase::drawPopupMenuBackground (Graphics& g, int width, int height)
{
    ...
    g.fillAll (background);
    g.setColour (background.overlaidWith (Colour (0x1badd8e6)));

    for (int i = 0; i < height; i += 3)
        g.fillRect (0, i, width, 1);

#if ! JUCE_MAC
    g.setColour (findColour (PopupMenu::textColourId).withAlpha (0.4f));
...
void LookAndFeelBase::drawPopupMenuItem (Graphics& g, const Rectangle<int>& area,
                                         ...
                                         const Drawable* icon, const Colour* const textColourToUse)
{
    ...
    else
    {
        ...
        Rectangle<float> iconArea (r.removeFromLeft ((r.getHeight() * 2) / 3).reduced (3).toFloat());
        ...
        r.removeFromRight (3);
        g.drawText(text, r, Justification::centredLeft);
...
void LookAndFeelBase::drawPopupMenuSectionHeader (Graphics& g, const Rectangle<int>& area, const String& sectionName)
{
...
void LookAndFeelBase::drawMenuBarBackground (Graphics& g, int width, int height, bool, MenuBarComponent& menuBar)
{
...
Font LookAndFeelBase::getMenuBarFont (MenuBarComponent& menuBar, int /*itemIndex*/, const String& /*itemText*/)
{
    return Font (menuBar.getHeight() * 0.7f);
}

int LookAndFeelBase::getMenuBarItemWidth (MenuBarComponent& menuBar, int itemIndex, const String& itemText)
{
    return getMenuBarFont (menuBar, itemIndex, itemText)
        .getStringWidth (itemText) + menuBar.getHeight();
}

void LookAndFeelBase::drawMenuBarItem (Graphics& g, int width, int height,
...
//==============================================================================
void LookAndFeelBase::fillTextEditorBackground (Graphics& g, int /*width*/, int /*height*/, TextEditor& textEditor)
{
    g.fillAll (textEditor.findColour (TextEditor::backgroundColourId));
}

void LookAndFeelBase::drawTextEditorOutline (Graphics& g, int width, int height, TextEditor& textEditor)
{
    ...
    {
        const Colour color = textEditor.findColour (TextEditor::outlineColourId);
        g.setColour (textEditor.isEnabled() ? color : color.withAlpha(0.5f));
        g.drawRect (0, 0, width, height);
...
CaretComponent* LookAndFeelBase::createCaretComponent (Component* keyFocusOwner)
{
    return new CaretComponent (keyFocusOwner);
}

//==============================================================================
void LookAndFeelBase::drawComboBox (Graphics& g, int width, int height, const bool isButtonDown,
...
Font LookAndFeelBase::getComboBoxFont (ComboBox& box)
{
    return Font (jmin (15.0f, box.getHeight() * 0.85f));
}

Label* LookAndFeelBase::createComboBoxTextBox (ComboBox&)
{
    return new Label (String::empty, String::empty);
}

void LookAndFeelBase::positionComboBoxText (ComboBox& box, Label& label)
{
    label.setBounds (1, 1,
...
//==============================================================================
Font LookAndFeelBase::getLabelFont (Label& label)
{
...
Button* LookAndFeelBase::createSliderButton (Slider&, const bool isIncrement)
{
    return new TextButton (isIncrement ? "+" : "-", String::empty);
}

class LookAndFeelBase::SliderLabelComp  : public Label
{
public:
...
ImageEffectFilter* LookAndFeelBase::getSliderEffect (Slider&)
{
    return nullptr;
}

Font LookAndFeelBase::getSliderPopupFont (Slider&)
{
    return Font (15.0f, Font::bold);
}

int LookAndFeelBase::getSliderPopupPlacement (Slider&)
{
...
//==============================================================================
Slider::SliderLayout LookAndFeelBase::getSliderLayout (Slider& slider)
{
...
void LookAndFeelBase::layoutFilenameComponent (FilenameComponent& filenameComp,
...
//==============================================================================
void LookAndFeelBase::drawConcertinaPanelHeader (Graphics& g, const Rectangle<int>& area,
...
//==============================================================================
void LookAndFeelBase::drawImageButton (Graphics& g, Image* image,
...
//==============================================================================
void LookAndFeelBase::drawCornerResizer (Graphics& g,
                                         int w, int h,
                                         bool /*isMouseOver*/,
                                         bool /*isMouseDragging*/)
{
    ...
    for (float i = 0.5f; i < 1.0f; i += 0.2f)
    {
...
void LookAndFeelBase::drawResizableFrame (Graphics& g, int w, int h, const BorderSize<int>& border)
{
}

//==============================================================================
void LookAndFeelBase::fillResizableWindowBackground (Graphics& g, int /*w*/, int /*h*/,
                                                     const BorderSize<int>& /*border*/, ResizableWindow& window)
{
    g.fillAll (window.getBackgroundColour());
}

void LookAndFeelBase::drawResizableWindowBorder (Graphics&, int /*w*/, int /*h*/,
                                                 const BorderSize<int>& /*border*/, ResizableWindow&)
{
}

void LookAndFeelBase::drawDocumentWindowTitleBar (DocumentWindow& window, Graphics& g,
                                                  int w, int h, int titleSpaceX, int titleSpaceW,
...
void LookAndFeelBase::positionDocumentWindowButtons (DocumentWindow&,
                                                     int titleBarX, int titleBarY,
                                                     int titleBarW, int titleBarH,
                                                     Button* minimiseButton,
                                                     Button* maximiseButton,
...
//==============================================================================
DropShadower* LookAndFeelBase::createDropShadowerForComponent (Component*)
{
    return new DropShadower (DropShadow (Colours::black.withAlpha (0.4f), 10, Point<int> (0, 2)));
}

//==============================================================================
void LookAndFeelBase::drawStretchableLayoutResizerBar (Graphics& g, int w, int h,
                                                       bool /*isVerticalBar*/,
                                                       bool isMouseOver,
                                                       bool isMouseDragging)
{
...
//==============================================================================
void LookAndFeelBase::drawGroupComponentOutline (Graphics& g, int width, int height,
...
int LookAndFeelBase::getTabButtonBestWidth (TabBarButton& button, int tabDepth)
{
...
Rectangle<int> LookAndFeelBase::getTabButtonExtraComponentBounds (const TabBarButton& button, Rectangle<int>& textArea, Component& comp)
{
...
void LookAndFeelBase::createTabButtonShape (TabBarButton& button, Path& p, bool /*isMouseOver*/, bool /*isMouseDown*/)
{
}

void LookAndFeelBase::fillTabButtonShape (TabBarButton& button, Graphics& g, const Path& path,
                                          bool /*isMouseOver*/, bool /*isMouseDown*/)
{
    
}

void LookAndFeelBase::drawTabButtonText (TabBarButton& button, Graphics& g, bool isMouseOver, bool isMouseDown)
{
    ...
    const float alpha = button.isEnabled() ? ((isMouseOver || isMouseDown || button.isFrontTab()) ? 1.0f : 0.8f) : 0.3f;

    g.setColour (ProjectInfo::colorLightBrown.withMultipliedAlpha (alpha));
    g.setFont (font);
    g.addTransform (t);
    ...
    const int btnIdx = button.getIndex();
    const int tabNum = button.getTabbedButtonBar().getNumTabs();
    if (button.getIndex() == 0)
    {
        line.setBounds (area.getRight(), area.getY()+5, 0.5f, 10.0f);
        g.fillRect(line);
    }
    else if (btnIdx > 0 && btnIdx < tabNum-1)
    {
        line.setBounds (area.getRight(), area.getY()+5, 0.5f, 10.0f);
        g.fillRect(line);
        line.setBounds (area.getX(), area.getY()+5, 0.5f, 10.0f);
        g.fillRect(line);
    }
    else if (btnIdx == tabNum-1)
    {
        line.setBounds (area.getX(), area.getY()+5, 0.5f, 10.0f);
        g.fillRect(line);
    }
...
void LookAndFeelBase::drawTabButton (TabBarButton& button, Graphics& g, bool isMouseOver, bool isMouseDown)
{
    const Colour tabBackground (button.getTabBackgroundColour());
    const bool isFrontTab = button.isFrontTab();
    const Rectangle<int> area (button.getActiveArea());
    if (isFrontTab)
    {
        g.setColour(tabBackground);
        g.fillRect(area.getCentreX()-10, area.getBottom()-1, 20, 1);
        g.setColour(ProjectInfo::colorLightBrown.withAlpha(0.3f));
        g.drawLine(juce::Line<float>(area.getCentreX()-10, area.getBottom(), area.getCentreX(), area.getBottom()-10), 1);
        g.drawLine(juce::Line<float>(area.getCentreX(), area.getBottom()-10, area.getCentreX()+10, area.getBottom()), 1);
    }

    drawTabButtonText (button, g, isMouseOver, isMouseDown);
}

void LookAndFeelBase::drawTabbedButtonBarBackground (TabbedButtonBar&, Graphics&) {}

void LookAndFeelBase::drawTabAreaBehindFrontButton (TabbedButtonBar& bar, Graphics& g, const int w, const int h)
{
    const float shadowSize = 0.0f;

    Rectangle<int> shadowRect, line;
    ColourGradient gradient (ProjectInfo::colorLightBrown.withAlpha (bar.isEnabled() ? 0.25f : 0.15f), 0, 0,
...
//==============================================================================
void LookAndFeelBase::drawTableHeaderBackground (Graphics& g, TableHeaderComponent& header)
{
...
void LookAndFeelBase::drawTableHeaderColumn (Graphics& g, const String& columnName, int /*columnId*/,
...
//==============================================================================
void LookAndFeelBase::drawLasso (Graphics& g, Component& lassoComp)
{
...
//==============================================================================
void LookAndFeelBase::paintToolbarBackground (Graphics& g, int w, int h, Toolbar& toolbar)
{
...
void LookAndFeelBase::paintToolbarButtonBackground (Graphics& g, int /*width*/, int /*height*/,
                                                    bool isMouseOver, bool isMouseDown,
...
void LookAndFeelBase::paintToolbarButtonLabel (Graphics& g, int x, int y, int width, int height,
                                               const String& text, /*bool isMouseOver, bool isMouseDown,*/
                                               ToolbarItemComponent& component)
{
    g.setColour (component.findColour (/*(isMouseOver || isMouseDown) ? Toolbar::labelTextOnColourId :*/ Toolbar::labelTextColourId, true)
        .withAlpha (component.isEnabled() ? 1.0f : 0.25f));

    const float fontHeight = jmax (14.0f, height * 0.85f);
...
//==============================================================================
void LookAndFeelBase::drawPropertyPanelSectionHeader (Graphics& g, const String& name,
...
void LookAndFeelBase::drawPropertyComponentBackground (Graphics& g, int width, int height, PropertyComponent& component)
{
    g.setColour (component.findColour (PropertyComponent::backgroundColourId));
    g.fillRect (0, 0, width, height - 1);
}

void LookAndFeelBase::drawPropertyComponentLabel (Graphics& g, int, int height, PropertyComponent& component)
{
...
Rectangle<int> LookAndFeelBase::getPropertyComponentContentPosition (PropertyComponent& component)
{
...
//==============================================================================
void LookAndFeelBase::drawCallOutBoxBackground (CallOutBox& box, Graphics& g,
...
int LookAndFeelBase::getCallOutBoxBorderSize (const CallOutBox&)
{
    return 20;
}

//==============================================================================
AttributedString LookAndFeelBase::createFileChooserHeaderText (const String& title,
...
void LookAndFeelBase::drawFileBrowserRow (Graphics& g, int width, int height,
...
void LookAndFeelBase::layoutFileBrowserComponent (FileBrowserComponent& browserComp,
...
//==============================================================================
void LookAndFeelBase::drawBevel (Graphics& g, const int x, const int y, const int width, const int height,
...
//==============================================================================
void LookAndFeelBase::drawShinyButtonShape (Graphics& g,
                                            float x, float y, float w, float h,
                                            float maxCornerSize,
...
//==============================================================================
void LookAndFeelBase::drawGlassSphere (Graphics& g, const float x, const float y,
...
//==============================================================================
void LookAndFeelBase::drawGlassPointer (Graphics& g,
...
//==============================================================================
void LookAndFeelBase::drawGlassLozenge (Graphics& g,
...
void LookAndFeelBase::createTabTextLayout (const TabBarButton& button, float length, float depth,
