...
void FileChooserDialogBox::createNewFolder()
{
    ...
    if (parent.isDirectory())
    {
        ...
        aw->addButton (true, Colour(0xFF0083B7), TRANS("Create Folder"), 1, KeyPress (KeyPress::returnKey));
        aw->addButton (true, Colour(0xFF0083B7), TRANS("Cancel"),        0, KeyPress (KeyPress::escapeKey));
