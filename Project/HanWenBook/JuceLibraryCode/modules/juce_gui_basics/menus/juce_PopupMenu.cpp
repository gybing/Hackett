...
public:
    ...
    void calculateWindowPos (const Rectangle<int>& target, const bool alignToRectangle)
    {
        ...
        {
            bool tendTowardsRight = options.showMenuLeft ? target.getX() < mon.getX() : (target.getX() + widthToUse < mon.getWidth());
...
PopupMenu::Options PopupMenu::Options::withLeft (bool left) const noexcept
{
    Options o (*this);
    o.showMenuLeft = left;
    return o;
