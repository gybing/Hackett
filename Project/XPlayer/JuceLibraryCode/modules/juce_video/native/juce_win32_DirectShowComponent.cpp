...
public:
    ...
    bool loadFile (const String& fileOrURLPath)
    {
        ...
        if (SUCCEEDED (hr))
        {
            ...
            switch (hr)
            {
            case S_OK: str = L"Success. "; break;
            case VFW_S_AUDIO_NOT_RENDERED: str = L"Partial success; the audio was not rendered. "; break;
            case VFW_S_DUPLICATE_NAME: str = L"Success; the Filter Graph Manager modified the filter name to avoid duplication. "; break;
            case VFW_S_PARTIAL_RENDER: str = L"Some of the streams in this movie are in an unsupported format. "; break;
            case VFW_S_VIDEO_NOT_RENDERED: str = L"Partial success; some of the streams in this movie are in an unsupported format. "; break;
            case E_ABORT: str = L"Operation aborted. "; break;
            case E_FAIL: str = L"Failure. "; break;
            case E_INVALIDARG: str = L"Argument is invalid. "; break;
            case E_OUTOFMEMORY: str = L"Insufficient memory. "; break;
            case E_POINTER: str = L"NULL pointer argument. "; break;
            case VFW_E_CANNOT_CONNECT: str = L"No combination of intermediate filters could be found to make the connection. "; break;
            case VFW_E_CANNOT_LOAD_SOURCE_FILTER: str = L"The source filter for this file could not be loaded. "; break;
            case VFW_E_CANNOT_RENDER: str = L"No combination of filters could be found to render the stream. "; break;
            case VFW_E_INVALID_FILE_FORMAT: str = L"The file format is invalid. "; break;
            case VFW_E_NOT_FOUND: str = L"An object or name was not found. "; break;
            case VFW_E_UNKNOWN_FILE_TYPE: str = L"The media type of this file is not recognized. "; break;
            case VFW_E_UNSUPPORTED_STREAM: str = L"Cannot play back the file: the format is not supported."; break;
            default:
                break;
            }
