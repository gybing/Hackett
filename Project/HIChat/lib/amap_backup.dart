...
class AMapBackWidget extends StatefulWidget {
  AMapBackWidget();

  factory AMapBackWidget.forDesignTime() => AMapBackWidget();

  @override
  _AMapBackWidgetState createState() => _AMapBackWidgetState();
}

class _AMapBackWidgetState extends State<AMapBackWidget> {
