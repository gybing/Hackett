...
inline float RandomFloat()                        { return Random::getSystemRandom().nextFloat() * 2.0f - 1.0f; }
inline float RandomFloat(float lo, float hi) { return Random::getSystemRandom().nextFloat() * (hi - lo) + lo; }
...
static LXAppType<Box2DDemo> demo ("29 Graphics: Box 2D");
