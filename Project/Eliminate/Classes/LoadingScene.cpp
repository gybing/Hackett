...
bool LoadingScene::init()
{
	...
	//预加载音效
    SimpleAudioEngine::getInstance()->preloadEffect("sound.Eliminate1.mp3");
    SimpleAudioEngine::getInstance()->preloadEffect("sound.Eliminate2.mp3");
    SimpleAudioEngine::getInstance()->preloadEffect("sound.Eliminate3.mp3");
    SimpleAudioEngine::getInstance()->preloadEffect("sound.Eliminate4.mp3");
    SimpleAudioEngine::getInstance()->preloadEffect("sound.Eliminate5.mp3");
    SimpleAudioEngine::getInstance()->preloadEffect("sound.Eliminate6.mp3");
    SimpleAudioEngine::getInstance()->preloadEffect("sound.Eliminate7.mp3");
    SimpleAudioEngine::getInstance()->preloadEffect("sound.Eliminate8.mp3");
    SimpleAudioEngine::getInstance()->preloadEffect("sound.Swap.mp3");
