...
String StartGetRandomText() {
  final List<String> text = [
    ...
    "当你无法从一楼蹦到三楼时.不好忘记走楼梯.要记住伟大的成功往往不是一蹴而就的.务必学习并领悟分解你的目标.逐步实施.",
    "不好对挫折叹气.姑且把这一切看成是在你成大事之前.务必经受的准备工作.",
    "奋斗没有终点.任何时候都是一个起点.",
    "不大可能的事也许这天实现.根本不可能的事也许明天会实现.",
    "没有人富有得能够不好别人的帮忙.也没有人穷得不能在某方面给他人帮忙.",
    ...
    "朋友是生命的丛林.是心灵歇脚的驿站.是收藏心事的寓所.是储蓄感情的行囊.不管人生路上几多风雨.朋友如伞.伴你一路晴空！愿你的天空更蓝人生最美.",
    ...
    "朋友不分距离.天涯同好.交得其道.朋友不分男女.真知灼同.同日而语.一首音乐.轻松和谐.一个问候.关怀体贴.一条短信.温馨弥漫.",
    ...
    "不要试图去解释这个世界上任何的误解和扭曲.存在的都是真理.任何人的成功.都不是虚头.他们一定付出了你没有想到的努力和代价.才华机遇运气努力外貌.甚至是不光彩的事情.都是存在.没什么值得怀疑.",
    ...
    "没有钱没有经验没有阅历没有社会关系.这些都不可怕.没有钱.可以通过辛勤劳动去赚.没有经验.可以通过实践操作去总结.没有阅历.可以一步一步去积累.没有社会关系.可以一点一点去编织.但是.没有梦想没有思路才是最可怕的.才让人感到恐惧.很想逃避！",
    ...
    "生命是需要奋斗的.奋斗与不奋斗.造就的结果截然不同.生无所息.保持奋斗的姿态.让世界变得如此灿烂.让你的人生绚烂多姿.千万不能满足小溪的平缓.否则你也就满足了自己的平庸.只有欣赏到山峰的险峻.才有机会欣赏自己.",
    "生命之舟将面对险滩.面对激流.弱者会选择逃避和放弃.而强者则会选择面对和挑战.人生中无限的乐趣都在于对人生的挑战之中迸出不衰的光芒.",
    "十几年的奋斗.给了我崭新的生活.十几年的奋斗.给了我冲向顶峰的动力.正如富强的中国一样.我.与许多不计辛劳的人.一起跨入梦想的殿堂."
  ];
  var index = Random().nextInt(text.length - 1);
  return text[index];
}
