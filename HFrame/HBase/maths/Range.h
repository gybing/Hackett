...
public:
    ...
    HCONSTEXPR Range() = default;

    /** Constructs a range with given start and end values. */
    HCONSTEXPR Range (const ValueType startValue, const ValueType endValue) noexcept
        : start (startValue), end (jmax (startValue, endValue))
    {
    }

    /** Constructs a copy of another range. */
    HCONSTEXPR Range (const Range&) = default;

    /** Copies another range object. */
    Range& operator= (const Range&) = default;

    /** Returns the range that lies between two positions (in either order). */
    HCONSTEXPR static Range between (const ValueType position1, const ValueType position2) noexcept
    {
    ...
    {
        HAssert (length >= ValueType());
        return Range (startValue, startValue + length);
    }

    /** Returns a range with the specified start position and a length of zero. */
    HCONSTEXPR static Range emptyRange (const ValueType start) noexcept
    {
    ...
    HCONSTEXPR inline ValueType getStart() const noexcept          { return start; }

    /** Returns the length of the range. */
    HCONSTEXPR inline ValueType getLength() const noexcept         { return end - start; }
    ...
    */
    HCONSTEXPR Range withStart (const ValueType newStart) const noexcept
    {
        return Range (newStart, jmax (newStart, end));
    }

    /** Returns a range with the same length as this one, but moved to have the given start position. */
    HCONSTEXPR Range movedToStartAt (const ValueType newStart) const noexcept
    {
    ...
    */
    ...
    /** Returns a range with the same start position as this one, but a different end.
        ...
        will be pushed back to equal the new end point.
    */
    HCONSTEXPR Range withEnd (const ValueType newEnd) const noexcept
    {
    ...
    HCONSTEXPR Range movedToEndAt (const ValueType newEnd) const noexcept
    {
    ...
    */
    ...
    /** Returns a range with the same start as this one, but a different length.
        Lengths less than zero are treated as zero.
    */
    HCONSTEXPR Range withLength (const ValueType newLength) const noexcept
    {
    ...
    */
    HCONSTEXPR Range expanded (ValueType amount) const noexcept
    {
    ...
    /** Returns a range that is equal to this one with an amount added to its
        start and end.
    */
    HCONSTEXPR Range operator+ (const ValueType amountToAdd) const noexcept
    {
    ...
    HCONSTEXPR Range operator- (const ValueType amountToSubtract) const noexcept
    {
        return Range (start - amountToSubtract, end - amountToSubtract);
    }

    HCONSTEXPR bool operator== (Range other) const noexcept     { return start == other.start && end == other.end; }
    HCONSTEXPR bool operator!= (Range other) const noexcept     { return start != other.start || end != other.end; }
    ...
    */
    HCONSTEXPR bool contains (const ValueType position) const noexcept
    {
    ...
    HCONSTEXPR bool contains (Range other) const noexcept
    {
        return start <= other.start && end >= other.end;
    }

    /** Returns true if the given range intersects this one. */
    HCONSTEXPR bool intersects (Range other) const noexcept
    {
    ...
    HCONSTEXPR Range getIntersectionWith (Range other) const noexcept
    {
    ...
    HCONSTEXPR Range getUnionWith (Range other) const noexcept
    {
    ...
    HCONSTEXPR Range getUnionWith (const ValueType valueToInclude) const noexcept
    {
