...
public:
    ...
    {
        HAssertfalse; // You shouldn't call this for an expression that's not actually a function!
        return {};
    }
...
struct Expression::Helpers
{
    ...
    public:
        ...
        {
            HAssert (left != nullptr && right != nullptr);
        }
    ...
    protected:
        ...
        {
            HAssert (input == left || input == right);
    ...
    private:
        ...
        private:
            HDECLARE_NON_COPYABLE (EvaluationVisitor)
        };
        ...
        private:
            ...
            HDECLARE_NON_COPYABLE (SymbolVisitingVisitor)
        };
        ...
        private:
            ...
            HDECLARE_NON_COPYABLE (SymbolRenamingVisitor)
        };

        SymbolTerm* getSymbol() const  { return static_cast<SymbolTerm*> (left.get()); }

        HDECLARE_NON_COPYABLE (DotOperator)
    };
    ...
    private:
        HDECLARE_NON_COPYABLE (Subtract)
    };
    ...
    public:
        ...
        HDECLARE_NON_COPYABLE (Multiply)
    };
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE (SymbolCheckVisitor)
    };
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE (SymbolListVisitor)
    };
