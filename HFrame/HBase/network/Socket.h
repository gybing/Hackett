...
/**
    ...
    @tags{Core}
*/
class API StreamingSocket  final
{
public:
    //==============================================================================
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (StreamingSocket)
};
...
/**
    ...
    @tags{Core}
*/
class API DatagramSocket  final
{
public:
    //==============================================================================
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DatagramSocket)
};
