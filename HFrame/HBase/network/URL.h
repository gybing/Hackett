...
public:
    ...
    */
    ...
    public:
       #if HIOS
        /** internal **/
        static void iosURLSessionNotify (const String&);
       #endif

    private:
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DownloadTask)
    };
...
private:
    ...
    struct Upload  : public ReferenceCountedObject
    {
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Upload)
    };
