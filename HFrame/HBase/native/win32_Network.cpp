...
private:
    ...
    {
        static HINTERNET sessionHandle = InternetOpen (_T("H"), INTERNET_OPEN_TYPE_PRECONFIG, 0, 0, 0);
...
struct GetAdaptersAddressesHelper
{
    bool callGetAdaptersAddresses()
    {
        ...
        HLOAD_WINAPI_FUNCTION (dll, GetAdaptersAddresses, getAdaptersAddresses, DWORD, (ULONG, ULONG, PVOID, PIP_ADAPTER_ADDRESSES, PULONG))
...
namespace MACAddressHelpers
{
    ...
    static void getViaNetBios (Array<MACAddress>& result)
    {
        ...
        HLOAD_WINAPI_FUNCTION (dll, Netbios, NetbiosCall, UCHAR, (PNCB))
                                                      ...
                                                      const StringArray& filesToAttach)
{
    ...
    HLOAD_WINAPI_FUNCTION (dll, MAPISendMail, mapiSendMail,
