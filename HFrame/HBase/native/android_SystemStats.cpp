...
namespace AndroidStatsHelpers
{
    ...
    {
        return HString (LocalRef<jstring> ((jstring) getEnv()->CallStaticObjectMethod (SystemClass,
    ...
    static inline String getLocaleValue (bool isRegion)
    {
        ...
        return HString (LocalRef<jstring> ((jstring) stringResult));
    }

    static inline String getAndroidOsBuildValue (const char* fieldName)
    {
        return HString (LocalRef<jstring> ((jstring) getEnv()->GetStaticObjectField (
