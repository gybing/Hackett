...
//==============================================================================
// This byte-code is generated from native/java/com/roli/H/JuceHTTPStream.java with min sdk version 16
...
//==============================================================================
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
 STATICMETHOD (createHTTPStream, "createHTTPStream", "(Ljava/lang/String;Z[BLjava/lang/String;I[ILjava/lang/StringBuffer;ILjava/lang/String;)Lcom/roli/H/JuceHTTPStream;") \
...
DECLARE_JNI_CLASS_WITH_BYTECODE (HTTPStream, "com/roli/H/JuceHTTPStream", 16, javaJuceHttpStream, sizeof(javaJuceHttpStream))
#undef JNI_CLASS_MEMBERS
...
API bool CALLTYPE Process::openEmailWithAttachments (const String& /*targetEmailAddress*/,
...
public:
    ...
    bool connect (WebInputStream::Listener* /*listener*/)
    {
        ...
        else
        {
            ...
            HAssert (Thread::getCurrentThread() != nullptr);

            jintArray statusCodeArray = env->NewIntArray (1);
            HAssert (statusCodeArray != 0);
            ...
            if (stream != 0)
            {
...

                {
                    ...
                    headerLines.addLines (HString (env, headersString));
                }
