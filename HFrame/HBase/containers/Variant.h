...
public:
    ...
    */
    HDEPRECATED_STATIC (static const var null;)
...
API bool operator== (const var&, const var&);
/** Compares the values of two var objects, using the var::equals() comparison. */
API bool operator!= (const var&, const var&);
/** Compares the values of two var objects, using the var::equals() comparison. */
API bool operator<  (const var&, const var&);
...
API bool operator== (const var&, const String&);
API bool operator!= (const var&, const String&);
API bool operator== (const var&, const char*);
API bool operator!= (const var&, const char*);
