...
public:
    ...
    */
    ...
    {
        const ScopedLockType lock (getLock());
        HAssert (isPositiveAndBelow (indexToChange, values.size()));
        values[indexToChange] = newValue;
    }
    ...
    */
    ...
    {
        HAssert (elementToRemove != nullptr);
        const ScopedLockType lock (getLock());

        HAssert (values.begin() != nullptr);
    ...
    */
    ...
    HDEPRECATED_WITH_BODY (void swapWithArray (Array& other) noexcept, { swapWith (other); })
   #endif
