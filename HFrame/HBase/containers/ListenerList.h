...
public:
    ...
    */
    void add (ListenerClass* listenerToAdd)
    {
        if (listenerToAdd != nullptr)
            ...
            HAssertfalse;  // Listeners can't be null pointers!
    }
    ...
    */
    ...
    {
        HAssert (listenerToRemove != nullptr); // Listeners can't be null pointers!
    ...
    */
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE (Iterator)
    };
...
private:
    ...
    HDECLARE_NON_COPYABLE (ListenerList)
};
