...
private:
    ...
    public:
        ...
        HDECLARE_NON_COPYABLE (HashEntry)
    };
...
private:
    ...
    int generateHashFor (KeyTypeParameter key, int numSlots) const
    {
        ...
        HAssert (isPositiveAndBelow (hash, numSlots)); // your hash function is generating out-of-range numbers!
        return hash;
    }
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (HashMap)
};
