...
public:
    ...
    */
    ObjectClass* set (int indexToChange, ObjectClass* newObject, bool deleteOldElement = true)
    {
        ...
        {
            HAssertfalse; // you're trying to set an object at a negative index, which doesn't have
    ...
    */
    ...
    HDEPRECATED_WITH_BODY (void swapWithArray (OwnedArray& other) noexcept, { swapWith (other); })
   #endif
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OwnedArray)
};
