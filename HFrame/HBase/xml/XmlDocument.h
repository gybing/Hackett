...
public:
    ...
    */
    ...
    /** A handy static method that parses a file.
        ...
        An even better shortcut is the parseXML() function, which returns a std::unique_ptr<XmlElement>!
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (XmlDocument)
};
