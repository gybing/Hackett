...
/**
    ...
    @tags{Core}
*/
class API SystemStats  final
{
public:
    //==============================================================================
    /** Returns the current version of H,
        See also the HVERSION, HMAJOR_VERSION and HMINOR_VERSION macros.
    */
    static String getHVersion();
    ...
    */
    ...
    HDEPRECATED_WITH_BODY (static int getCpuSpeedInMegaherz(), { return getCpuSpeedInMegahertz(); })

private:
    SystemStats() = delete; // uses only static methods
    HDECLARE_NON_COPYABLE (SystemStats)
};
