...
public:
    ...
    */
    ...
    /** Special realtime audio thread priority
        ...
        In this case, H will ask OpenSL/Oboe to construct a super high priority thread
    ...
    */
    ...
    /** Changes the affinity mask for the caller thread.
        ...
        @see setAffinityMask
    */
    static void CALLTYPE setCurrentThreadAffinityMask (uint32 affinityMask);
    ...
    */
    static void CALLTYPE sleep (int milliseconds);
    ...
    */
    ...
    /** Returns an id that identifies the caller thread.
        ...
        @see getThreadId
    */
    static ThreadID CALLTYPE getCurrentThreadId();

    /** Finds the thread object that is currently running.

        Note that the main UI thread (or other non-H threads) don't have a Thread
        object associated with them, so this will return nullptr.
    */
    static Thread* CALLTYPE getCurrentThread();
    ...
    */
    static void CALLTYPE setCurrentThreadName (const String& newThreadName);

   #if HANDROID || defined (DOXYGEN)
    //==============================================================================
    /** Initialises the H subsystem for projects not created by the Projector

        On Android, H needs to be initialised once before it is used. The Projector
        will automatically generate the necessary java code to do this. However, if
        you are using H without the Projector or are creating a library made with
        H intended for use in non-H apks, then you must call this method
        ...
        @code
        com.roli.H.Java.initialiseH (myContext);
        @endcode

        Note that the above java method is only available in Android Studio projects
        created by the Projector. If you need to call this from another type of project
        ...
        public class Java
        {
            ...
            public native static void initialiseH (Context context);
        }
        @endcode
        ...
        @param jContext this is a jobject referring to your app/service/receiver/
                        provider's Context. H needs this for many of it's internal
                        functions.
    */
    static void initialiseH (void* jniEnv, void* jContext);
   #endif
...
private:
   ...
   #ifndef DOXYGEN
    friend void API threadEntryPoint (void*);
   #endif
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Thread)
};
