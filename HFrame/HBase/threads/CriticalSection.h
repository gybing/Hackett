...
private:
    //==============================================================================
   #if HWINDOWS
    // To avoid including windows.h in the public H headers, we'll just allocate
    ...
    HDECLARE_NON_COPYABLE (CriticalSection)
};
...
/**
    ...
    @tags{Core}
*/
class API DummyCriticalSection
{
public:
...
private:
    HDECLARE_NON_COPYABLE (DummyCriticalSection)
};
