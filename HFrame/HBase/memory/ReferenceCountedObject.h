...
/**
    ...
    @tags{Core}
*/
class API ReferenceCountedObject
{
public:
    //==============================================================================
...
/**
    ...
    @tags{Core}
*/
class API SingleThreadedReferenceCountedObject
{
public:
    //==============================================================================
    /** Increments the object's reference count.
...
public:
    ...
    */
    ...
    {
        HAssert (referencedObject != nullptr); // null pointer method call!
    ...
    /** Dereferences the object that this pointer references.
        The pointer returned may be null, of course.
    */
    ReferencedType& operator*() const noexcept              { HAssert (referencedObject != nullptr); return *referencedObject; }
    ...
    /** Returns the object that this pointer references.
        ...
        with the pointer, it's safer to disable this by setting HSTRICT_REFCOUNTEDPOINTER=1, which
    ...
    */
    ...
    HDEPRECATED_WITH_BODY (ReferencedType* getObject() const, { return get(); })
