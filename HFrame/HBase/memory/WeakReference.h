...
/**
    ...
    OR: just use the handy HDECLARE_WEAK_REFERENCEABLE macro to do all this for you.
...
public:
    ...
    */
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE (SharedPointer)
    };
    ...
    */
    ...
    public:
        ...
        ~Master() noexcept
        {
            ...
            HAssert (sharedPointer == nullptr || sharedPointer->get() == nullptr);
        }
        ...
        */
        SharedRef getSharedPointer (ObjectType* object)
        {
            ...
            else
            {
                ...
                HAssert (sharedPointer->get() != nullptr);
            }
...
/**
     ...
     private:
         HDECLARE_WEAK_REFERENCEABLE (MyObject)
     };
     @endcode

     @see WeakReference, WeakReference::Master
*/
#define HDECLARE_WEAK_REFERENCEABLE(Class) \
