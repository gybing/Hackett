...
/**
    ...
    This macro is used in the H classes themselves, so your application has a chance to
    intercept and translate any internal H text strings that might be shown. (You can easily
    get a list of all the messages by searching for the TRANS() macro in the H source
    code).

    @tags{Core}
*/
class API LocalisedStrings
{
public:
    //==============================================================================
...
private:
    ...
    HLEAK_DETECTOR (LocalisedStrings)
};
 ...
 */
 #define TRANS(stringLiteral) translate (stringLiteral)
#endif
...
*/
API String translate (const String& stringLiteral);

/** Uses the LocalisedStrings class to translate the given string literal.
    @see LocalisedStrings
*/
API String translate (const char* stringLiteral);
...
/** Uses the LocalisedStrings class to translate the given string literal.
    @see LocalisedStrings
*/
API String translate (const String& stringLiteral, const String& resultIfNotFound);
