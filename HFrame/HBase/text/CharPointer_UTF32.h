...
public:
    ...
    inline wchar operator*() const noexcept        { return *data; }
    ...
    inline wchar getAndAdvance() noexcept  { return *data++; }
    ...
    inline wchar& operator[] (int characterIndex) const noexcept
    {
    ...
    inline void write (wchar charToWrite) noexcept
    {
        *data++ = charToWrite;
    }

    inline void replaceChar (wchar newChar) noexcept
    {
        *data = newChar;
    }
    ...
    {
       #if HNATIVE_WCHAR_IS_UTF32 && ! HANDROID
        return wcslen (data);
       #else
        size_t n = 0;
        while (data[n] != 0)
    ...
    */
    static inline size_t getBytesRequiredFor (wchar) noexcept
    {
    ...
    */
    ...
    int indexOf (wchar charToFind) const noexcept
    {
        int i = 0;
    ...
    /** Returns the character index of a unicode character, or -1 if it isn't found. */
    int indexOf (wchar charToFind, bool ignoreCase) const noexcept
    {
    ...
    wchar toUpperCase() const noexcept     { return CharacterFunctions::toUpperCase (*data); }
    /** Returns a lower-case version of the first character of this string. */
    wchar toLowerCase() const noexcept     { return CharacterFunctions::toLowerCase (*data); }
