...
public:
    ...
    wchar operator[] (int characterIndex) const noexcept
    {
        auto p (*this);
        p += characterIndex;
        return *p;
    ...
    void write (wchar charToWrite) noexcept
    {
    ...
    */
    static size_t getBytesRequiredFor (wchar charToWrite) noexcept
    {
    ...
    */
    ...
    wchar toUpperCase() const noexcept     { return CharacterFunctions::toUpperCase (operator*()); }
    /** Returns a lower-case version of the first character of this string. */
    wchar toLowerCase() const noexcept     { return CharacterFunctions::toLowerCase (operator*()); }
    ...
    */
    ...
    {
        HAssert (possibleByteOrder != nullptr);
