...
public:
    ...
    {
        HAssert (*data != 0); // trying to advance past the end of the string?
    ...
    */
    static size_t getBytesRequiredFor (const wchar charToWrite) noexcept
    {
        size_t num = 1;
    ...
    */
    ...
    void write (const wchar charToWrite) noexcept
    {
        auto c = (uint32) charToWrite;
