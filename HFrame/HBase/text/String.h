...
public:
    ...
    */
    ...
    static String charToString (wchar character);
    ...
    /** This is the character encoding type used internally to store the string.
        ...
        By setting the value of HSTRING_UTF_TYPE to 8, 16, or 32, you can change the
    ...
    */
   #if (HSTRING_UTF_TYPE == 32)
    using CharPointerType = CharPointer_UTF32;
   #elif (HSTRING_UTF_TYPE == 16)
    using CharPointerType = CharPointer_UTF16;
   #elif (DOXYGEN || HSTRING_UTF_TYPE == 8)
    using CharPointerType = CharPointer_UTF8;
   #else
    #error "You must set the value of HSTRING_UTF_TYPE to be either 8, 16, or 32!"
   #endif
    ...
    /** Appends a character at the end of this string. */
    String& operator+= (wchar characterToAppend);
   #endif
    ...
    */
    ...
    /** Tests whether the string begins with a particular character.
        ...
        Uses a case-sensitive comparison.
    */
    bool startsWithChar (wchar character) const noexcept;
    ...
    */
    ...
    /** Tests whether the string ends with a particular character.
        ...
        Uses a case-sensitive comparison.
    */
    bool endsWithChar (wchar character) const noexcept;
    ...
    */
    int indexOfChar (wchar characterToLookFor) const noexcept;
    ...
    /** Searches for a character inside this string.
        ...
        @returns            the index of the first occurrence of the character in this
                            string, or -1 if it's not found.
    */
    int indexOfChar (int startIndex, wchar characterToLookFor) const noexcept;
    ...
    */
    wchar getLastCharacter() const noexcept;
    ...
    */
    ...
    String replaceCharacter (wchar characterToReplace,
                             wchar characterToInsertInstead) const;
    ...
    */
    String quoted (wchar quoteCharacter = '"') const;
    ...
    */
    String paddedLeft (wchar padCharacter, int minimumLength) const;

    /** Returns a copy of this string with the specified character repeatedly added to its
        end until the total length is at least the minimum length specified.
    */
    String paddedRight (wchar padCharacter, int minimumLength) const;
    ...
    */
    ...
    {
        HAssert (numberOfSignificantFigures > 0);
    ...
    */
    HDEPRECATED_STATIC (static const String empty;)
...
private:
    ...
    HDEPRECATED (String (const String&, size_t));
...
API String CALLTYPE operator+ (const char* string1,     const String& string2);
/** Concatenates two strings. */
API String CALLTYPE operator+ (const wchar_t* string1,  const String& string2);
/** Concatenates two strings. */
API String CALLTYPE operator+ (char string1,            const String& string2);
/** Concatenates two strings. */
API String CALLTYPE operator+ (wchar_t string1,         const String& string2);
#if ! HNATIVE_WCHAR_IS_UTF32
/** Concatenates two strings. */
API String CALLTYPE operator+ (wchar string1,      const String& string2);
#endif

/** Concatenates two strings. */
API String CALLTYPE operator+ (String string1, const String& string2);
/** Concatenates two strings. */
API String CALLTYPE operator+ (String string1, const char* string2);
/** Concatenates two strings. */
API String CALLTYPE operator+ (String string1, const wchar_t* string2);
/** Concatenates two strings. */
API String CALLTYPE operator+ (String string1, const std::string& string2);
/** Concatenates two strings. */
API String CALLTYPE operator+ (String string1, char characterToAppend);
/** Concatenates two strings. */
API String CALLTYPE operator+ (String string1, wchar_t characterToAppend);
#if ! HNATIVE_WCHAR_IS_UTF32
/** Concatenates two strings. */
API String CALLTYPE operator+ (String string1, wchar characterToAppend);
#endif
...
API String& CALLTYPE operator<< (String& string1, const String& string2);
/** Appends a string to the end of the first one. */
API String& CALLTYPE operator<< (String& string1, StringRef string2);
/** Appends a string to the end of the first one. */
API String& CALLTYPE operator<< (String& string1, const std::string& string2);

/** Appends a decimal number to the end of a string. */
API String& CALLTYPE operator<< (String& string1, uint8 number);
/** Appends a decimal number to the end of a string. */
API String& CALLTYPE operator<< (String& string1, short number);
/** Appends a decimal number to the end of a string. */
API String& CALLTYPE operator<< (String& string1, int number);
/** Appends a decimal number to the end of a string. */
API String& CALLTYPE operator<< (String& string1, long number);
/** Appends a decimal number to the end of a string. */
API String& CALLTYPE operator<< (String& string1, unsigned long number);
/** Appends a decimal number to the end of a string. */
API String& CALLTYPE operator<< (String& string1, int64 number);
/** Appends a decimal number to the end of a string. */
API String& CALLTYPE operator<< (String& string1, uint64 number);
/** Appends a decimal number to the end of a string. */
API String& CALLTYPE operator<< (String& string1, float number);
/** Appends a decimal number to the end of a string. */
API String& CALLTYPE operator<< (String& string1, double number);

#ifndef DOXYGEN
// Automatically creating a String from a bool opens up lots of nasty type conversion edge cases.
// If you want a String representation of a bool you can cast the bool to an int first.
String& CALLTYPE operator<< (String&, bool) = delete;
#endif

//==============================================================================
/** Case-sensitive comparison of two strings. */
API bool CALLTYPE operator== (const String& string1, const String& string2) noexcept;
/** Case-sensitive comparison of two strings. */
API bool CALLTYPE operator== (const String& string1, const char* string2) noexcept;
/** Case-sensitive comparison of two strings. */
API bool CALLTYPE operator== (const String& string1, const wchar_t* string2) noexcept;
/** Case-sensitive comparison of two strings. */
API bool CALLTYPE operator== (const String& string1, CharPointer_UTF8 string2) noexcept;
/** Case-sensitive comparison of two strings. */
API bool CALLTYPE operator== (const String& string1, CharPointer_UTF16 string2) noexcept;
/** Case-sensitive comparison of two strings. */
API bool CALLTYPE operator== (const String& string1, CharPointer_UTF32 string2) noexcept;
...
//==============================================================================
/** This operator allows you to write a H String directly to std output streams.
    This is handy for writing strings to std::cout, std::cerr, etc.
*/
template <class traits>
std::basic_ostream <char, traits>& CALLTYPE operator<< (std::basic_ostream <char, traits>& stream, const String& stringToWrite)
{
...
*/
template <class traits>
std::basic_ostream <wchar_t, traits>& CALLTYPE operator<< (std::basic_ostream <wchar_t, traits>& stream, const String& stringToWrite)
{
    return stream << stringToWrite.toWideCharPointer();
}

/** Writes a string to an OutputStream as UTF8. */
API OutputStream& CALLTYPE operator<< (OutputStream& stream, const String& stringToWrite);

/** Writes a string to an OutputStream as UTF8. */
API OutputStream& CALLTYPE operator<< (OutputStream& stream, StringRef stringToWrite);
...
namespace std
{
    ...
    {
        size_t operator() (const String& s) const noexcept    { return s.hash(); }
    };
}
#endif
