...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PerformanceCounter)
};
...
/**
    ...
    @tags{Core}
*/
class API ScopedTimeMeasurement
{
public:
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ScopedTimeMeasurement)
};
