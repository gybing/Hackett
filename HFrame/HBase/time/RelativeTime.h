...
API bool CALLTYPE operator== (RelativeTime t1, RelativeTime t2) noexcept;
/** Compares two RelativeTimes. */
API bool CALLTYPE operator!= (RelativeTime t1, RelativeTime t2) noexcept;
/** Compares two RelativeTimes. */
API bool CALLTYPE operator>  (RelativeTime t1, RelativeTime t2) noexcept;
...
API RelativeTime  CALLTYPE operator+  (RelativeTime t1, RelativeTime t2) noexcept;
