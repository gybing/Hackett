...
public:
    ...
    */
    static Time CALLTYPE getCurrentTime() noexcept;
...
API Time operator+ (Time time, RelativeTime delta) noexcept;
/** Adds a RelativeTime to a Time. */
API Time operator+ (RelativeTime delta, Time time) noexcept;

/** Subtracts a RelativeTime from a Time. */
API Time operator- (Time time, RelativeTime delta) noexcept;
/** Returns the relative time difference between two times. */
API const RelativeTime operator- (Time time1, Time time2) noexcept;

/** Compares two Time objects. */
API bool operator== (Time time1, Time time2) noexcept;
/** Compares two Time objects. */
API bool operator!= (Time time1, Time time2) noexcept;
/** Compares two Time objects. */
API bool operator<  (Time time1, Time time2) noexcept;
