                                                           ...
                                                           FloatType beta)
{
    ...
    HAssert (frequency > 0 && frequency <= sampleRate * 0.5);
                                                           ...
                                                           FloatType amplitudedB)
{
    HAssert (sampleRate > 0);
    HAssert (frequency > 0 && frequency <= sampleRate * 0.5);
    HAssert (normalisedTransitionWidth > 0 && normalisedTransitionWidth <= 0.5);
    HAssert (amplitudedB >= -100 && amplitudedB <= 0);
                                                                 ...
                                                                 FloatType stopBandWeight)
{
    ...
    HAssert (frequency > 0 && frequency <= sampleRate * 0.5);
    HAssert (normalisedTransitionWidth > 0 && normalisedTransitionWidth <= 0.5);
    HAssert (stopBandWeight >= 1.0 && stopBandWeight <= 100.0);
...
{
    HAssert (normalisedTransitionWidth > 0 && normalisedTransitionWidth <= 0.5);
    HAssert (amplitudedB >= -300 && amplitudedB <= -10);
                                                                     ...
                                                                     FloatType stopbandAmplitudedB)
{
    ...
    HAssert (frequency > 0 && frequency <= sampleRate * 0.5);
    HAssert (normalisedTransitionWidth > 0 && normalisedTransitionWidth <= 0.5);
    HAssert (passbandAmplitudedB > -20 && passbandAmplitudedB < 0);
    HAssert (stopbandAmplitudedB > -300 && stopbandAmplitudedB < -20);
...
{
    HAssert (normalisedTransitionWidth > 0 && normalisedTransitionWidth <= 0.5);
    HAssert (stopbandAmplitudedB > -300 && stopbandAmplitudedB < -10);
