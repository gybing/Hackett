...
public:
    ...
    */
    ...
    {
        HAssert (startSample < static_cast<size_t> (buffer.getNumSamples()));
    }
    ...
    */
    ...
    {
        HAssert (channelStart < numChannels);
        HAssert ((channelStart + numChannelsToUse) <= numChannels);
    ...
    */
    ...
    {
        HAssert (isPositiveAndBelow (channel, numChannels));
        HAssert (isPositiveAndBelow (sampleIndex, numSamples));
    ...
    */
    ...
    {
        HAssert (isPositiveAndBelow (destChannel, numChannels));
        HAssert (isPositiveAndBelow (destSample, numSamples));
    ...
    */
    ...
    forcedinline AudioBlock& HVECTOR_CALLTYPE fill (SampleType value) noexcept
    {
        auto n = static_cast<int> (numSamples * sizeFactor);
    ...
    /** Copy the values from a H's AudioBuffer to the receiver.
    ...
    */
    ...
    /** Copy the values from the receiver to a H's AudioBuffer.
    ...
    */
    ...
    {
        HAssert (srcPos <= numSamples && dstPos <= numSamples);
    ...
    */
    ...
    {
        HAssert (newOffset < numSamples);
        HAssert (newOffset + newLength <= numSamples);
    ...
    */
    ...
    forcedinline AudioBlock& HVECTOR_CALLTYPE add (SampleType value) noexcept
    {
        auto n = static_cast<int> (numSamples * sizeFactor);
    ...
    {
        HAssert (numChannels == src.numChannels);
    ...
    template <typename OtherSampleType>
    forcedinline AudioBlock& HVECTOR_CALLTYPE add (AudioBlock<OtherSampleType> src, SampleType value) noexcept
    {
        HAssert (numChannels == src.numChannels);
        auto n = static_cast<int> (jmin (numSamples, src.numSamples) * sizeFactor);
    ...
    {
        HAssert (numChannels == src1.numChannels && src1.numChannels == src2.numChannels);
    ...
    forcedinline AudioBlock& HVECTOR_CALLTYPE subtract (SampleType value) noexcept
    {
    ...
    template <typename OtherSampleType>
    forcedinline AudioBlock& HVECTOR_CALLTYPE subtract (AudioBlock<OtherSampleType> src, SampleType value) noexcept
    {
    ...
    forcedinline AudioBlock& HVECTOR_CALLTYPE multiply (SampleType value) noexcept
    {
        auto n = static_cast<int> (numSamples * sizeFactor);
    ...
    template <typename OtherSampleType>
    forcedinline AudioBlock& HVECTOR_CALLTYPE multiply (AudioBlock<OtherSampleType> src, SampleType value) noexcept
    {
        HAssert (numChannels == src.numChannels);
        auto n = static_cast<int> (jmin (numSamples, src.numSamples) * sizeFactor);
    ...
    template <typename OtherSampleType>
    forcedinline AudioBlock& HVECTOR_CALLTYPE addWithMultiply (AudioBlock<OtherSampleType> src, SampleType factor) noexcept
    {
        HAssert (numChannels == src.numChannels);
        auto n = static_cast<int> (jmin (numSamples, src.numSamples) * sizeFactor);
    ...
    forcedinline AudioBlock& HVECTOR_CALLTYPE operator+= (SampleType src) noexcept   { return add (src); }
    forcedinline AudioBlock&                      operator+= (AudioBlock src) noexcept   { return add (src); }
    forcedinline AudioBlock& HVECTOR_CALLTYPE operator-= (SampleType src) noexcept   { return subtract (src); }
    forcedinline AudioBlock&                      operator-= (AudioBlock src) noexcept   { return subtract (src); }
    forcedinline AudioBlock& HVECTOR_CALLTYPE operator*= (SampleType src) noexcept   { return multiply (src); }
    ...
    */
    ...
    static void process (AudioBlock<Src1SampleType> inBlock, AudioBlock<Src2SampleType> outBlock, FunctionType&& function)
    {
        ...
        HAssert (len == outBlock.getNumSamples());
        HAssert (numChans == outBlock.getNumChannels());
