...
/**
    ...
    impulse response in the frequency domain, using the H FFT class.
...
public:
    ...
    */
    ...
    /** This function loads an impulse response audio file from memory, added in a
        H project with the Projector as binary data. It can load any of the audio
        formats registered in H, and performs some resampling and pre-processing
        as well if needed.
    ...
    */
    ...
    /** This function loads an impulse response from an audio file on any drive. It
        can load any of the audio formats registered in H, and performs some
...
private:
    ...
    //==============================================================================
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Convolution)
};
