...
public:
    ...
    */
    ...
    SampleType HVECTOR_CALLTYPE processSample (SampleType input) noexcept
    {
        HAssert (isInitialised());
    ...
    void process (const ProcessContext& context) noexcept
    {
        ...
        HAssert (outBlock.getNumSamples() <= static_cast<size_t> (rampBuffer.size()));
