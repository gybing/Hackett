...
public:
    ...
    */
    ...
    {
        HAssert (newBias >= static_cast<FloatType> (-1) && newBias <= static_cast<FloatType> (1));
    ...
    */
    ...
    void process (const ProcessContext& context) noexcept
    {
        ...
        HAssert (inBlock.getNumChannels() == outBlock.getNumChannels());
        HAssert (inBlock.getNumSamples() == outBlock.getNumSamples());
