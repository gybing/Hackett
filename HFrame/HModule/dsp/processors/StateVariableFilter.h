    ...
    */
    ...
    public:
        ...
        */
        ...
        SampleType HVECTOR_CALLTYPE processSample (SampleType sample) noexcept
        {
    ...
    private:
        ...
        SampleType HVECTOR_CALLTYPE processLoop (SampleType sample, Parameters<NumericType>& state) noexcept
        {
        ...
        void processInternal (const ProcessContext& context) noexcept
        {
            ...
            HAssert (inputBlock.getNumChannels()  == 1);
            HAssert (outputBlock.getNumChannels() == 1);
    ...
    struct Parameters  : public ProcessorState
    {
        ...
        */
                                 ...
                                 NumericType resonance = static_cast<NumericType> (1.0 / MathConstants<double>::sqrt2)) noexcept
        {
            ...
            HAssert (resonance > NumericType (0));
            HAssert (frequency > NumericType (0) && frequency <= NumericType (sampleRate * 0.5));
