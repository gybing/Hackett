...
struct ProcessorDuplicator
{
    ...
    {
        HAssert ((int) context.getInputBlock().getNumChannels()  <= processors.size());
        HAssert ((int) context.getOutputBlock().getNumChannels() <= processors.size());
...
private:
    ...
    OwnedArray<MonoProcessorType> processors;
};
