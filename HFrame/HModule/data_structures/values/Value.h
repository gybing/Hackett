...
public:
    ...
    */
    class API ValueSource   : public ReferenceCountedObject,
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ValueSource)
    };
...
OutputStream& CALLTYPE operator<< (OutputStream&, const Value&);
