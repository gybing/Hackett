...
public:
    ...
    */
    HDEPRECATED_STATIC (static const ValueTree invalid;)

private:
    //==============================================================================
    HPUBLIC_IN_DLL_BUILD (class SharedObject)
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE (ComparatorAdapter)
    };
