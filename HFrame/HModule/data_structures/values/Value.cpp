...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SimpleValueSource)
};
...
Value::Value (Value&& other) noexcept
{
    ...
    HAssert (other.listeners.size() == 0);
...
OutputStream& CALLTYPE operator<< (OutputStream& stream, const Value& value)
{
