...
namespace ComponentBuilderHelpers
{
                                          ...
                                          const ValueTree& state, Component* parent)
    {
        ...
        HAssert (c != nullptr && c->getParentComponent() == parent);
...
ComponentBuilder::~ComponentBuilder()
{
    ...
    HAssert (componentRef.get() == component.get());
   #endif
}
