...
/**
    ...
    @tags{GUI}
*/
class API MultiDocumentPanelWindow  : public DocumentWindow
{
public:
    //==============================================================================
    /**
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MultiDocumentPanelWindow)
};
...
/**
    ...
    @tags{GUI}
*/
class API MultiDocumentPanel  : public Component,
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MultiDocumentPanel)
};
