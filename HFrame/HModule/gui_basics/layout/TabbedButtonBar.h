...
/** In a TabbedButtonBar, this component is used for each of the buttons.
    ...
    @tags{GUI}
*/
class API TabBarButton  : public Button
{
public:
    //==============================================================================
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TabBarButton)
};
...
/**
    ...
    @tags{GUI}
*/
class API TabbedButtonBar  : public Component,
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TabbedButtonBar)
};
