...
/**
    ...
    @tags{GUI}
*/
class API ComponentBuilder  : private ValueTree::Listener
{
public:
    ...
    */
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TypeHandler)
    };
    ...
    */
    ...
    /** Registers handlers for various standard H components. */
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ComponentBuilder)
};
