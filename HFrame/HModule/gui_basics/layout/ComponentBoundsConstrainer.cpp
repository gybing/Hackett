...
{
    HAssert (maxW >= minimumWidth);
    HAssert (maxH >= minimumHeight);
    HAssert (minimumWidth > 0 && minimumHeight > 0);
...
{
    HAssert (maximumWidth >= minW);
    HAssert (maximumHeight >= minH);
    HAssert (maximumWidth > 0 && maximumHeight > 0);
...
{
    HAssert (maximumWidth >= minimumWidth);
    HAssert (maximumHeight >= minimumHeight);
    HAssert (maximumWidth > 0 && maximumHeight > 0);
    HAssert (minimumWidth > 0 && minimumHeight > 0);
