...
void MultiDocumentPanelWindow::maximiseButtonPressed()
{
    if (auto* owner = getOwner())
        ...
        HAssertfalse; // these windows are only designed to be used inside a MultiDocumentPanel!
}
                                      ...
                                      const bool deleteWhenRemoved)
{
    ...
    HAssert (dynamic_cast<ResizableWindow*> (component) == nullptr);
                                        ...
                                        const bool checkItsOkToCloseFirst)
{
    if (components.contains (component))
    {
        ...
        {
            HAssert (components.indexOf (component) >= 0);
