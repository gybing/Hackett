...
//==============================================================================
/**
    The original H look-and-feel, as used back from 2002 to about 2007ish.
    @see LookAndFeel, LookAndFeel_V2, LookAndFeel_V3

    @tags{GUI}
*/
class API LookAndFeel_V1    : public LookAndFeel_V2
{
public:
    LookAndFeel_V1();
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LookAndFeel_V1)
};
