...
//==============================================================================
/**
    This LookAndFeel subclass implements the H style from around 2008-12.

    @see LookAndFeel, LookAndFeel_V1, LookAndFeel_V3

    @tags{GUI}
*/
class API LookAndFeel_V2  : public LookAndFeel
{
public:
    LookAndFeel_V2();
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LookAndFeel_V2)
};
