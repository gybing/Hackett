...
//==============================================================================
/**
    The latest H look-and-feel style, as introduced in 2017.
    @see LookAndFeel, LookAndFeel_V1, LookAndFeel_V2, LookAndFeel_V3

    @tags{GUI}
*/
class API LookAndFeel_V4   : public LookAndFeel_V3
{
public:
    /**
...
private:
    ...
    //==============================================================================
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LookAndFeel_V4)
};
