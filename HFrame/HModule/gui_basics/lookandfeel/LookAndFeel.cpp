...
extern GetTypefaceForFont GetTypefaceForFont;
...
LookAndFeel::LookAndFeel()
{
    ...
    */
    HAssert (Colours::white == Colour (0xffffffff));

    GetTypefaceForFont = getTypefaceForFontFromLookAndFeel;
}
...
LookAndFeel::~LookAndFeel()
{
    ...
    */
    HAssert (masterReference.getNumActiveWeakReferences() == 0
