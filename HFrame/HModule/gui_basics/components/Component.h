...
//==============================================================================
/**
    The base class for all H user-interface objects.

    @tags{GUI}
*/
class API Component  : public MouseListener
{
public:
    //==============================================================================
    /** Creates a component.
    ...
    */
    ...
    /** Makes this component appear as a window on the desktop.
        ...
        @param nativeWindowToAttachTo       this allows an OS object to be passed-in as the window
                                            in which the H component should place itself. On Windows,
    ...
    */
    static float CALLTYPE getApproximateScaleFactorForComponent (Component* targetComponent);
    ...
    */
    static Component* CALLTYPE getCurrentlyFocusedComponent() noexcept;

    /** If any component has keyboard focus, this will defocus it. */
    static void CALLTYPE unfocusAllComponents();
    ...
    */
    ...
    /** Components can override this method to draw their content.
        ...
        to paint any bits that need refreshing. In H (and almost all modern UI frameworks),
    ...
    */
    static void CALLTYPE beginDragAutoRepeat (int millisecondsBetweenCallbacks);
    ...
    */
    static bool CALLTYPE isMouseButtonDownAnywhere() noexcept;
    ...
    */
    ...
    /** Returns the number of components that are currently in a modal state.
        @see getCurrentlyModalComponent
     */
    static int CALLTYPE getNumCurrentlyModalComponents() noexcept;
    ...
    */
    static Component* CALLTYPE getCurrentlyModalComponent (int index = 0) noexcept;
    ...
    */
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE (BailOutChecker)
    };
    ...
    */
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Positioner)
    };
...
private:
    ...
    */
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Component)
