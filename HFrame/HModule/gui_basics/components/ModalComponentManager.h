...
/**
    ...
    @tags{GUI}
*/
class API ModalComponentManager   : private AsyncUpdater,
...
public:
    ...
    */
    ...
    //==============================================================================
   #ifndef DOXYGEN
    HDECLARE_SINGLETON_SINGLETHREADED_MINIMAL (ModalComponentManager)
   #endif
...
private:
    ...
    HDECLARE_NON_COPYABLE (ModalComponentManager)
};
...
/**
    ...
    @tags{GUI}
*/
class API ModalCallbackFunction
{
public:
