...
public:
    ...
    */
    ...
    private:
        HDECLARE_NON_COPYABLE (ElementBase)
    };

    //==============================================================================
    /** Class for the start sub path element */
    class API StartSubPath  : public ElementBase
    {
    public:
    ...
    private:
        HDECLARE_NON_COPYABLE (StartSubPath)
    };

    //==============================================================================
    /** Class for the close sub path element */
    class API CloseSubPath  : public ElementBase
    {
    public:
        CloseSubPath();
        void addToPath (Path& path, Expression::Scope*) const override;
    ...
    private:
        HDECLARE_NON_COPYABLE (CloseSubPath)
    };

    //==============================================================================
    /** Class for the line to element */
    class API LineTo  : public ElementBase
    {
    public:
    ...
    private:
        HDECLARE_NON_COPYABLE (LineTo)
    };

    //==============================================================================
    /** Class for the quadratic to element */
    class API QuadraticTo  : public ElementBase
    {
    public:
    ...
    private:
        HDECLARE_NON_COPYABLE (QuadraticTo)
    };

    //==============================================================================
    /** Class for the cubic to element */
    class API CubicTo  : public ElementBase
    {
    public:
...
private:
    ...
    HLEAK_DETECTOR (RelativePointPath)
};
