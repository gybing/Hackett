...
private:
    ...
    HDECLARE_NON_COPYABLE (RelativeRectangleLocalScope)
};
...
public:
    ...
    void applyToComponentBounds() override
    {
        ...
        HAssertfalse; // Seems to be a recursive reference!
    }
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (RelativeRectangleComponentPositioner)
};
