...
struct CustomMouseCursorInfo
{
    ...
    HDECLARE_NON_COPYABLE (CustomMouseCursorInfo)
};
...
public:
          ...
          isStandard (false)
    {
        ...
        HAssert (image.getBounds().contains (hotSpot));
    }
    ...
    {
        HAssert (isPositiveAndBelow (type, MouseCursor::NumStandardCursorTypes));
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SharedCursorHandle)
};
