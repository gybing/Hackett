...
/**
    ...
    @tags{GUI}
*/
class API DragAndDropContainer
{
public:
    //==============================================================================
    ...
    */
    ...
    /** Begins a drag-and-drop operation.
        ...
        @param inputSourceCausingDrag            the mouse input source which started the drag. When calling
                                                 ...
                                                 MouseEvent::source to this method. If this param is nullptr then H
                                                 ...
                                                 then H will use the mouseInputSource which is closest to the sourceComponent.
    */
    ...
    */
    ...
    /** This performs an asynchronous drag-and-drop of a set of files to some external
        ...
        @param sourceComponent  normally, H will assume that the component under the mouse is the source component
...
protected:
    /** Override this if you want to be able to perform an external drag of a set of files
        ...
        This method will be called when a drag operation moves outside the H window,
...
private:
    ...
    HDEPRECATED_WITH_BODY (virtual bool shouldDropFilesWhenDraggedExternally (const String&, Component*, StringArray&, bool&), { return false; })

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DragAndDropContainer)
};
