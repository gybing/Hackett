...
public:
    ...
    */
    ...
    {
        HAssert (source == nullptr);  // this suggests that you didn't call endLasso() after the last drag...
        HAssert (lassoSource != nullptr); // the source can't be null!
        HAssert (getParentComponent() != nullptr);  // you need to add this to a parent component for it to work!
    ...
    */
    ...
    void paint (Graphics& g) override
    {
        ...
        // mouse-up event.
        HAssert (isMouseButtonDownAnywhere());
    }
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LassoComponent)
};
