...
private:
    ...
    HDEPRECATED_WITH_BODY (virtual int backgroundClicked(), { return 0; })
   #endif
};
...
/**
    ...
    @tags{GUI}
*/
class API ListBox  : public Component,
...
private:
    //==============================================================================
    HPUBLIC_IN_DLL_BUILD (class ListViewport)
    HPUBLIC_IN_DLL_BUILD (class RowComponent)
    ...
    HDEPRECATED (void setSelectedRows (const SparseSet<int>&, bool));
    ...
    HDEPRECATED (virtual void createSnapshotOfSelectedRows (int&, int&)) {}
   #endif

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ListBox)
};
