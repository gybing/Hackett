...
/**
    ...
    @tags{GUI}
*/
class API Slider  : public Component,
...
private:
    //==============================================================================
    HPUBLIC_IN_DLL_BUILD (class Pimpl)
    ...
    HDEPRECATED (void setValue (double, bool));
    HDEPRECATED (void setValue (double, bool, bool));
    HDEPRECATED (void setMinValue (double, bool, bool, bool));
    HDEPRECATED (void setMinValue (double, bool, bool));
    HDEPRECATED (void setMinValue (double, bool));
    HDEPRECATED (void setMaxValue (double, bool, bool, bool));
    HDEPRECATED (void setMaxValue (double, bool, bool));
    HDEPRECATED (void setMaxValue (double, bool));
    HDEPRECATED (void setMinAndMaxValues (double, double, bool, bool));
    HDEPRECATED (void setMinAndMaxValues (double, double, bool));
    virtual void snapValue (double, bool) {}
   #endif

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Slider)
};
