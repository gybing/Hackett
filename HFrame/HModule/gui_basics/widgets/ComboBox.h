...
/**
    ...
    @tags{GUI}
*/
class API ComboBox  : public Component,
...
public:
    ...
    */
    ...
    HDEPRECATED (void clear (bool));
    HDEPRECATED (void setSelectedId (int, bool));
    HDEPRECATED (void setSelectedItemIndex (int, bool));
    HDEPRECATED (void setText (const String&, bool));
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ComboBox)
};
