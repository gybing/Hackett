...
/**
    ...
    @tags{GUI}
*/
class API TextEditor  : public Component,
...
public:
    ...
    */
    class API LengthAndCharacterRestriction  : public InputFilter
    {
    public:
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LengthAndCharacterRestriction)
    };
...
private:
    //==============================================================================
    HPUBLIC_IN_DLL_BUILD (class UniformTextSection)
    struct Iterator;
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TextEditor)
};
