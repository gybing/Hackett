...
public:
    ...
    */
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OpennessRestorer)
    };
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TreeViewItem)
};
...
/**
    ...
    @tags{GUI}
*/
class API TreeView  : public Component,
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TreeView)
};
