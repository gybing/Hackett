...
private:
    ...
    //==============================================================================
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MultiChoiceRemapperSource)
};
...
private:
    ...
    //==============================================================================
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MultiChoiceRemapperSourceWithDefault)
};
    ...
    : PropertyComponent (propertyName, 70)
{
    ...
    // the choices array!
    HAssert (choices.size() == correspondingValues.size());
    ...
    : MultiChoicePropertyComponent (propertyName, choices, correspondingValues)
{
    ...
    HAssert (valueToControl.getValue().isArray());
    ...
    : MultiChoicePropertyComponent (propertyName, choices, correspondingValues)
{
    ...
    // The value to control must be an array!
    HAssert (valueWithDefault->get().isArray());
