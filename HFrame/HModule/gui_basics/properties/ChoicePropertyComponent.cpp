...
protected:
    ...
    //==============================================================================
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (RemapperValueSource)
};
...
private:
    ...
    //==============================================================================
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (RemapperValueSourceWithDefault)
};
      ...
      choices (choiceList)
{
    ...
    // the choices array!
    HAssert (correspondingValues.size() == choices.size());
...
{
    HAssertfalse; // you need to override this method in your subclass!
}
