...
/**
    ...
    HApplicationBase or HApplication, and implement its various pure virtual
    methods.
    ...
    Note that this class is derived from HApplicationBase, which contains most
    ...
    your app object directly from HApplicationBase if you want to, and by doing so
    can avoid having a dependency on the gui_basics module.
    ...
    @see HApplicationBase, START_HAPPLICATION

    @tags{GUI}
*/
class API HApplication  : public HApplicationBase,
                                   public ApplicationCommandTarget
{
public:
    //==============================================================================
    /** Constructs a H app object.

        If subclasses implement a constructor or destructor, they shouldn't call any
        H code in there - put your startup/shutdown code in initialise() and
        shutdown() instead.
    */
    HApplication();
    ...
    */
    ...
    static HApplication* CALLTYPE getInstance() noexcept;
...
private:
    ...
    HDECLARE_NON_COPYABLE (HApplication)
};
