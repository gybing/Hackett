...
public:
    ...
    */
    static bool CALLTYPE dismissAllActiveMenus();
    ...
    */
    ...
    private:
        ...
        HLEAK_DETECTOR (MenuItemIterator)
    };
    ...
    */
    class API CustomComponent  : public Component,
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CustomComponent)
    };
    ...
    */
    class API CustomCallback  : public SingleThreadedReferenceCountedObject
    {
    public:
        CustomCallback();
    ...
    private:
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CustomCallback)
    };
...
private:
    //==============================================================================
    HPUBLIC_IN_DLL_BUILD (struct HelperClasses)
