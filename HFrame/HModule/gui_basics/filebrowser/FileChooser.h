...
public:
    ...
    */
    ...
    /** Returns the last document that was chosen by one of the browseFor methods.
        ...
        convert this file to a H File class via the URL::getLocalFile method.
    ...
    */
    ...
    /** Returns if a native filechooser is currently available on this platform.
        ...
        and code-signing enabled in the Projector and have added iCloud containers
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FileChooser)
};
