...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (NonNative)
};
...
FileChooser::Pimpl* FileChooser::createPimpl (int flags, FilePreviewComponent* previewComp)
{
    ...
    HAssert (previewComp == nullptr || (previewComp->getWidth() > 10
    ...
    HAssert (! (((flags & FileBrowserComponent::saveMode) != 0)
