                             ...
                             const KeyPress& shortcutKey2)
{
    ...
    HAssert (buttonWidths.size() == buttons.size());
    int i = 0;
...
public:
    ...
    HDECLARE_NON_COPYABLE (AlertTextComp)
};
...
private:
    ...
    void show()
    {
        ...
        HAssert (alertBox != nullptr); // you have to return one of these!

        alertBox->setAlwaysOnTop (areThereAnyAlwaysOnTopWindows());
