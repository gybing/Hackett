...
/**
    ...
    @tags{GUI}
*/
class API ResizableWindow  : public TopLevelWindow
{
public:
    //==============================================================================
    ...
    */
    ...
    HDEPRECATED (void setContentComponent (Component* newContentComponent,
...
private:
    ...
    HDEPRECATED (void getBorderThickness (int& left, int& top, int& right, int& bottom));
    HDEPRECATED (void getContentComponentBorder (int& left, int& top, int& right, int& bottom));
   #endif

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ResizableWindow)
};
