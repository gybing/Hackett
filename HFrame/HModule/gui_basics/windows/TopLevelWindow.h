...
/**
    ...
    @tags{GUI}
*/
class API TopLevelWindow  : public Component
{
public:
    //==============================================================================
    ...
    */
    ...
    /** Sets whether an OS-native title bar will be used, or a H one.
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TopLevelWindow)
};
