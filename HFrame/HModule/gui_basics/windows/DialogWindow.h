...
/**
    ...
    @tags{GUI}
*/
class API DialogWindow   : public DocumentWindow
{
public:
    //==============================================================================
    ...
    */
    struct API  LaunchOptions
    {
        ...
        */
        ...
        HDECLARE_NON_COPYABLE (LaunchOptions)
    };
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DialogWindow)
};
