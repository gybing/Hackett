...
public:
    ...
    */
    ...
    static void CALLTYPE showMessageBox (AlertWindow::AlertIconType iconType,
                                              const String& title,
    ...
    */
    static void CALLTYPE showMessageBoxAsync (AlertWindow::AlertIconType iconType,
                                                    const String& title,
                                                    const String& message,
                                                    Component* associatedComponent = nullptr,
    ...
    /** Shows a dialog box with two buttons.
        ...
        @see ModalCallbackFunction
    */
    static bool CALLTYPE showOkCancelBox (AlertWindow::AlertIconType iconType,
                                               const String& title,
                                               const String& message,
                                            #if HMODAL_LOOPS_PERMITTED
                                               Component* associatedComponent = nullptr,
    ...
    /** Shows a dialog box with three buttons.
        ...
        @see ModalCallbackFunction
    */
    static int CALLTYPE showYesNoCancelBox (AlertWindow::AlertIconType iconType,
                                                 const String& title,
                                                 const String& message,
                                               #if HMODAL_LOOPS_PERMITTED
                                                 Component* associatedComponent = nullptr,
    ...
    /** Shows a dialog box with two buttons.
        ...
        @see ModalCallbackFunction
    */
    static int CALLTYPE showYesNoBox (AlertWindow::AlertIconType iconType,
                                           const String& title,
                                           const String& message,
                                          #if HMODAL_LOOPS_PERMITTED
                                           Component* associatedComponent = nullptr,
...
private:
    ...
    HDECLARE_NON_COPYABLE (NativeMessageBox)
};
