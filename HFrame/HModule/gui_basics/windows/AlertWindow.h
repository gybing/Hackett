...
/** A window that displays a message and has buttons for the user to react to it.
    ...
    @tags{GUI}
*/
class API AlertWindow  : public TopLevelWindow
{
public:
    //==============================================================================
    ...
    */
    ...
    /** Shows a dialog box that just has a message and a single button to get rid of it.
        ...
        @param associatedComponent   if this is non-null, it specifies the component that the
                            ...
                            and feel, this might be used for positioning of the alert window.
    */
    static void CALLTYPE showMessageBox (AlertIconType iconType,
                                              const String& title,
                                              const String& message,
    ...
    */
    static void CALLTYPE showMessageBoxAsync (AlertIconType iconType,
                                                   const String& title,
                                                   const String& message,
                                                   const String& buttonText = String(),
                                                   Component* associatedComponent = nullptr,
    ...
    */
    static bool CALLTYPE showOkCancelBox (AlertIconType iconType,
                                               const String& title,
                                               const String& message,
                                            #if HMODAL_LOOPS_PERMITTED
    ...
    */
    static int CALLTYPE showYesNoCancelBox (AlertIconType iconType,
                                                 const String& title,
                                                 const String& message,
                                               #if HMODAL_LOOPS_PERMITTED
                                                 const String& button1Text = String(),
    ...
    */
   #if HMODAL_LOOPS_PERMITTED
    static bool CALLTYPE showNativeDialogBox (const String& title,
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AlertWindow)
};
