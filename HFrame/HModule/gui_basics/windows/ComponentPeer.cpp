...
bool ComponentPeer::handleDragExit (const ComponentPeer::DragInfo& info)
{
    ...
    HAssert (dragAndDropTargetComponent == nullptr);
...
void ComponentPeer::setCurrentRenderingEngine (int index)       { HAssert (index == 0); ignoreUnused (index); }
