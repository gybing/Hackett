...
/**
    ...
    @tags{GUI}
*/
class API Desktop  : private DeletedAtShutdown,
                           private Timer,
...
public:
    ...
    static Desktop& CALLTYPE getInstance();
    ...
    */
    ...
    /** This lets you prevent the screensaver from becoming active.
        ...
        The disablement will only happen while the H application is the foreground
    ...
    */
    ...
    /** Finds the component at a given screen location.
        ...
        Returns nullptr if the coordinates are inside a non-H window.
    */
    ...
    */
    ...
    /** Returns the number of mouse-sources that are currently being dragged.
        ...
        H component has the button down on it. In a multi-touch system, this could
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Desktop)
};
