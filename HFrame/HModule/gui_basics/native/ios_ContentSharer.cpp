...
public:
    ...
    void shareFiles (const Array<URL>& files) override
    {
        ...
        for (const auto& f : files)
        {
            ...
            if (f.isLocalFile())
            {
                nativeFilePath = HStringToNS (f.getLocalFile().getFullPathName());
            }
            else
            {
                ...
                auto* fileDirectory = filePath.contains ("/")
                                    ? HStringToNS (filePath.upToLastOccurrenceOf ("/", false, false))
                                    : [NSString string];

                auto fileName = HStringToNS (filePath.fromLastOccurrenceOf ("/", false, false)
                                                        .upToLastOccurrenceOf (".", false, false));

                auto fileExt = HStringToNS (filePath.fromLastOccurrenceOf (".", false, false));
    ...
    {
        auto array = [NSArray arrayWithObject: HStringToNS (text)];
        share (array);
    }
