...
namespace H
{
// This byte-code is generated from native/java/com/roli/H/ComponentPeerView.java with min sdk version 16
...
//==============================================================================
 ...
 extern bool handleNotificationIntent (void*);
 extern void firebaseDeviceNotificationsTokenRefreshed (void*);
 extern void firebaseRemoteNotificationReceived (void*);
 extern void firebaseRemoteMessagesDeleted();
 extern void firebaseRemoteMessageSent(void*);
 extern void firebaseRemoteMessageSendError (void*, void*);

#if HIN_APP_PURCHASES
 extern void inAppPurchaseCompleted (void*);
#endif

extern void contentSharingCompleted (int);
...
private:
    ...
    DECLARE_JNI_CLASS_WITH_BYTECODE (ComponentPeerView, "com/roli/H/ComponentPeerView", 16, javaComponentPeerView, sizeof (javaComponentPeerView))
    #undef JNI_CLASS_MEMBERS
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PreallocatedImage)
    };

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AndroidComponentPeer)
};
...
//==============================================================================
// TODO
API bool CALLTYPE Process::isForegroundProcess() { return true; }
...
//==============================================================================
class DialogListener  : public AndroidInterfaceImplementer
{
public:
...
bool CALLTYPE NativeMessageBox::showOkCancelBox (AlertWindow::AlertIconType /*iconType*/,
                                                      ...
                                                      ModalComponentManager::Callback* callback)
{
    HAssert (callback != nullptr); // on android, all alerts must be non-modal!!
...
void Desktop::setKioskComponent (Component* kioskComp, bool enableOrDisable, bool allowMenusAndBars)
{
    ...
    if (AndroidComponentPeer* peer = dynamic_cast<AndroidComponentPeer*> (kioskComp->getPeer()))
        ...
        HAssertfalse; // (this should have been checked by the caller)
}
...
//==============================================================================
class LayoutChangeListener  : public AndroidInterfaceImplementer
{
public:
...
private:
    jobject invoke (jobject proxy, jobject method, jobjectArray args) override
    {
        ...
        {
            HAssert (env->GetArrayLength (args) == 9);
...
{
    HAssertfalse;    // no such thing on Android!
    return false;
}
...
String SystemClipboard::getTextFromClipboard()
{
    ...
    return HString(LocalRef<jstring> ((jstring) env->CallObjectMethod(charSequence.get(), JavaCharSequence.toString)));
}
