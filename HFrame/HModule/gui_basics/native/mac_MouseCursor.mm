...
namespace MouseCursorHelpers
{
    ...
    static void* fromHIServices (const char* filename)
    {
        HAUTORELEASEPOOL
        {
            ...
            NSImage* originalImage = [[NSImage alloc] initByReferencingFile: HStringToNS (cursorPath + "/cursor.pdf")];
            ...
            NSDictionary* info = [NSDictionary dictionaryWithContentsOfFile: HStringToNS (cursorPath + "/info.plist")];
