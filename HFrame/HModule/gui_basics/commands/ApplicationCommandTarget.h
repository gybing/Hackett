...
/**
    ...
    @tags{GUI}
*/
class API ApplicationCommandTarget
{
public:
    //==============================================================================
...
private:
    ...
    HDECLARE_WEAK_REFERENCEABLE (ApplicationCommandTarget)
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ApplicationCommandTarget)
};
