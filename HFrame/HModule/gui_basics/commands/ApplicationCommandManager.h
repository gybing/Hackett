...
/**
    ...
    HApplication object (which is itself an ApplicationCommandTarget).
    ...
    @tags{GUI}
*/
class API ApplicationCommandManager   : private AsyncUpdater,
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ApplicationCommandManager)
};
...
/**
    ...
    @tags{GUI}
*/
class API ApplicationCommandManagerListener
{
public:
    //==============================================================================
    /** Destructor. */
