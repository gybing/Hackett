...
public:
    Direct2DFactories()
    {
        ...
        {
            HLOAD_WINAPI_FUNCTION (direct2dDll, D2D1CreateFactory, d2d1CreateFactory,
        ...
        {
            HLOAD_WINAPI_FUNCTION (directWriteDll, DWriteCreateFactory, dWriteCreateFactory,
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Direct2DFactories)
};
...
public:
    ...
    {
        HAssert (fontCollection != nullptr);
...
private:
    ...
    struct PathGeometrySink  : public ComBaseClassHelper<IDWriteGeometrySink>
    {
        ...
        HCOMRESULT Close() override  { return S_OK; }

        Path path;

        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PathGeometrySink)
    };

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (WindowsDirectWriteTypeface)
};
