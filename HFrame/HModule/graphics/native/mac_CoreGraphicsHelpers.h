...
CGImageRef createCoreGraphicsImage (const Image&, CGColorSpaceRef, bool mustOutliveSource);
CGContextRef getImageContext (const Image&);

#if HIOS
 Image createImageFromUIImage (UIImage*);
#endif
