...
struct FTLibWrapper  : public ReferenceCountedObject
{
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FTLibWrapper)
};
...
struct FTFaceWrapper     : public ReferenceCountedObject
{
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FTFaceWrapper)
};
...
public:
    ...
    struct KnownTypeface
    {
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (KnownTypeface)
    };
    ...
    HDECLARE_SINGLETON_SINGLETHREADED_MINIMAL (FTTypefaceList)
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FTTypefaceList)
};

HIMPLEMENT_SINGLETON (FTTypefaceList)
...
private:
    ...
    HDECLARE_NON_COPYABLE (FreeTypeTypeface)
};
