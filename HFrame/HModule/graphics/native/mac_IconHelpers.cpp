...
extern Image API getIconFromApplication (const String&, int);
...
static Image getIconFromIcnsFile (const File& icnsFile, const int size)
{
    ...
    OwnedArray<ImageFileFormat> internalFormats;
...
Image API getIconFromApplication (const String& applicationPath, const int size)
{
    Image hostIcon;
