...
public:
        ...
        : Typeface ({}, {}), canBeUsedForLayout (false), dataCopy (data, dataSize)
    {
        ...
        if (fontRef != nullptr)
        {
           #if HMAC && defined (MAC_OS_X_VERSION_10_8) && MAC_OS_X_VERSION_MIN_REQUIRED >= MAC_OS_X_VERSION_10_8
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OSXTypeface)
};
...
{
    HAssertfalse; // not implemented on this platform
}
