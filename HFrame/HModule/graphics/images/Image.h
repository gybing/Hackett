...
public:
    ...
    */
    ...
    private:
        HDECLARE_NON_COPYABLE (BitmapData)
    };
    ...
    */
    HDEPRECATED_STATIC (static const Image null;)

private:
    //==============================================================================
    ReferenceCountedObjectPtr<ImagePixelData> image;

    HLEAK_DETECTOR (Image)
};
...
/**
    ...
    @tags{Graphics}
*/
class API ImagePixelData  : public ReferenceCountedObject
{
public:
...
private:
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ImagePixelData)
};
...
/**
    ...
    @tags{Graphics}
*/
class API SoftwareImageType   : public ImageType
{
public:
    SoftwareImageType();
...
/**
    ...
    @tags{Graphics}
*/
class API NativeImageType   : public ImageType
{
public:
    NativeImageType();
