                ...
                else
                {
                    ...
                    if (std::abs (angle1 - angle2) > angleIncrement)
                    {
                             ...
                             || (angle2 < angle1 && angle2 >= angle1 - MathConstants<float>::pi))
                        {
                            ...
                            HAssert (angle1 <= angle2 + MathConstants<float>::pi);
                                         ...
                                         float extraAccuracy) const
{
    ...
    for (;;)
    {
        ...
        HAssert (dashLen >= 0); // must be a positive increment!
        if (dashLen <= 0)
            continue;
