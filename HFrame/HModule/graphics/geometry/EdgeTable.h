    ...
    */
    ...
    void iterate (EdgeTableIterationCallback& iterationCallback) const noexcept
    {
        ...
        for (int y = 0; y < bounds.getHeight(); ++y)
        {
            ...
            {
                int x = *++line;
                HAssert ((x >> 8) >= bounds.getX() && (x >> 8) < bounds.getRight());
                ...
                while (--numPoints >= 0)
                {
                    ...
                    HAssert (isPositiveAndBelow (level, 256));
                    const int endX = *++line;
                    HAssert (endX >= x);
                    ...
                    else
                    {
                        ...
                        if (level > 0)
                        {
                            HAssert (endOfRun <= bounds.getRight());
                ...
                {
                    x >>= 8;
                    HAssert (x >= bounds.getX() && x < bounds.getRight());
