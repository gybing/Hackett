...
/**
    ...
    load and save it in the H typeface format.
    ...
    @tags{Graphics}
*/
class API Typeface  : public ReferenceCountedObject
{
public:
    //==============================================================================
    ...
    */
    ...
    /** Returns the value by which you should multiply a H font-height value to
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Typeface)
};
