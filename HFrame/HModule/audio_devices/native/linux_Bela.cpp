...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BelaMidiInput)
};
...
private:
    ...
    void render (BelaContext& context)
    {
        ...
        if (callback != nullptr)
        {
            HAssert (context.audioFrames <= actualBufferSize);
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BelaAudioIODevice)
};
...
struct BelaAudioIODeviceType  : public AudioIODeviceType
{
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BelaAudioIODeviceType)
};
