...
namespace DSoundLogging
{
    ...
    #define HDS_LOG(a)        DSoundLogging::logMessage(a);
    #define HDS_LOG_ERROR(a)  DSoundLogging::logError(a, __LINE__);
   #else
    #define HDS_LOG(a)
    #define HDS_LOG_ERROR(a)
   #endif
}
...
namespace
{
    ...
    #define DSOUND_FUNCTION_LOAD(functionName) \
        ...
        HAssert (ds##functionName != nullptr);
...
public:
    ...
    void close()
    {
        ...
        {
            HDS_LOG ("closing output: " + name);
            HRESULT hr = pOutputBuffer->Stop();
            HDS_LOG_ERROR (hr); ignoreUnused (hr);
    ...
    String open()
    {
        HDS_LOG ("opening output: " + name + "  rate=" + String (sampleRate)
...
private:
    ...
    HDECLARE_NON_COPYABLE (DSoundInternalOutChannel)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE (DSoundInternalInChannel)
};
...
public:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DSoundAudioIODevice)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DSoundAudioIODeviceType)
};
