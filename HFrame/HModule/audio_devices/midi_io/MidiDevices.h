...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MidiInput)
};
...
/**
    ...
    @tags{Audio}
*/
class API MidiOutput  final  : private Thread
{
public:
    //==============================================================================
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MidiOutput)
};
