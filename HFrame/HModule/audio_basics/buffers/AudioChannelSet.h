...
public:
    ...
    */
    ...
    /** Creates a zero-channel set which can be used to indicate that a
        bus is disabled. */
    static AudioChannelSet CALLTYPE disabled();
    ...
    */
    static AudioChannelSet CALLTYPE mono();
    ...
    */
    static AudioChannelSet CALLTYPE stereo();
    ...
    */
    static AudioChannelSet CALLTYPE createLCR();
    ...
    */
    static AudioChannelSet CALLTYPE createLRS();
    ...
    */
    static AudioChannelSet CALLTYPE createLCRS();
    ...
    */
    static AudioChannelSet CALLTYPE create5point0();
    ...
    */
    static AudioChannelSet CALLTYPE create5point1();
    ...
    */
    static AudioChannelSet CALLTYPE create6point0();
     ...
     */
    static AudioChannelSet CALLTYPE create6point1();
    ...
    */
    static AudioChannelSet CALLTYPE create6point0Music();
    ...
    */
    static AudioChannelSet CALLTYPE create6point1Music();
    ...
    */
    static AudioChannelSet CALLTYPE create7point0();
     ...
     */
    static AudioChannelSet CALLTYPE create7point0SDDS();
    ...
    */
    static AudioChannelSet CALLTYPE create7point1();
    ...
    */
    static AudioChannelSet CALLTYPE create7point1SDDS();
    ...
    */
    static AudioChannelSet CALLTYPE create7point0point2();
    ...
    */
    static AudioChannelSet CALLTYPE create7point1point2();
     ...
     */
    static AudioChannelSet CALLTYPE quadraphonic();
    ...
    */
    static AudioChannelSet CALLTYPE pentagonal();
    ...
    */
    static AudioChannelSet CALLTYPE hexagonal();
    ...
    */
    static AudioChannelSet CALLTYPE octagonal();
    ...
    */
    static AudioChannelSet CALLTYPE ambisonic (int order = 1);
    ...
    */
    ...
    static AudioChannelSet CALLTYPE discreteChannels (int numChannels);

    /** Create a canonical channel set for a given number of channels.
        For example, numChannels = 1 will return mono, numChannels = 2 will return stereo, etc. */
    static AudioChannelSet CALLTYPE canonicalChannelSet (int numChannels);
    ...
    static AudioChannelSet CALLTYPE namedChannelSet (int numChannels);

    /** Return an array of channel sets which have a given number of channels */
    static Array<AudioChannelSet> CALLTYPE channelSetsWithNumberOfChannels (int numChannels);
    ...
    static String CALLTYPE getChannelTypeName (ChannelType);

    /** Returns the abbreviated name of a channel type. For example, this method may return "Ls". */
    static String CALLTYPE getAbbreviatedChannelTypeName (ChannelType);

    /** Returns the channel type from an abbreviated name. */
    static ChannelType CALLTYPE getChannelTypeFromAbbreviation (const String& abbreviation);
    ...
    */
    static AudioChannelSet CALLTYPE channelSetWithChannels (const Array<ChannelType>&);

    //==============================================================================
    // Conversion between wave and H channel layout identifiers

    /** Create an AudioChannelSet from a WAVEFORMATEXTENSIBLE channelMask (typically used
        in .wav files). */
    static AudioChannelSet CALLTYPE fromWaveChannelMask (int32 dwChannelMask);
...
private:
    ...
    //==============================================================================
    static int CALLTYPE getAmbisonicOrderForNumChannels (int);
};
