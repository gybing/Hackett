...
{
    HAssert (isPositiveAndBelow (order, 6));
...
AudioChannelSet CALLTYPE AudioChannelSet::channelSetWithChannels (const Array<ChannelType>& channelArray)
{
    AudioChannelSet set;

    for (auto ch : channelArray)
    {
        HAssert (! set.channels[static_cast<int> (ch)]);
...
//==============================================================================
AudioChannelSet CALLTYPE AudioChannelSet::fromWaveChannelMask (int32 dwChannelMask)
{
...
//==============================================================================
int CALLTYPE AudioChannelSet::getAmbisonicOrderForNumChannels (int numChannels)
{
