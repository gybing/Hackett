...
public:
    ...
    */
    AudioBuffer (Type* const* dataToReferTo,
        ...
        : numChannels (numChannelsToUse),
          size (numSamples)
    {
        HAssert (dataToReferTo != nullptr);
        HAssert (numChannelsToUse >= 0 && numSamples >= 0);
    ...
    */
    ...
    {
        HAssert (dataToReferTo != nullptr);
        HAssert (numChannelsToUse >= 0 && startSample >= 0 && numSamples >= 0);
    ...
    */
    ...
    {
        HAssert (isPositiveAndBelow (channelNumber, numChannels));
    ...
    */
    ...
    {
        HAssert (isPositiveAndBelow (channelNumber, numChannels));
        HAssert (isPositiveAndBelow (sampleIndex, size));
    ...
    */
    ...
    {
        HAssert (newNumChannels >= 0);
        HAssert (newNumSamples >= 0);
    ...
    */
    ...
    {
        HAssert (dataToReferTo != nullptr);
        HAssert (newNumChannels >= 0 && newNumSamples >= 0);
    ...
    */
    ...
    {
        HAssert (startSample >= 0 && numSamples >= 0 && startSample + numSamples <= size);
    ...
    */
    void setSample (int destChannel, int destSample, Type newValue) noexcept
    {
        ...
        HAssert (isPositiveAndBelow (destSample, size));
    ...
    */
    ...
    {
        HAssert (&source != this || sourceChannel != destChannel);
        HAssert (isPositiveAndBelow (destChannel, numChannels));
        HAssert (destStartSample >= 0 && numSamples >= 0 && destStartSample + numSamples <= size);
        HAssert (isPositiveAndBelow (sourceChannel, source.numChannels));
        HAssert (sourceStartSample >= 0 && sourceStartSample + numSamples <= source.size);
    ...
    */
                   ...
                   int numSamples) noexcept
    {
        HAssert (&source != this || sourceChannel != destChannel);
        HAssert (isPositiveAndBelow (destChannel, numChannels));
        HAssert (destStartSample >= 0 && destStartSample + numSamples <= size);
        HAssert (isPositiveAndBelow (sourceChannel, source.numChannels));
        HAssert (sourceStartSample >= 0 && numSamples >= 0 && sourceStartSample + numSamples <= source.size);
...
private:
    ...
    void allocateChannels (Type* const* dataToReferTo, int offset)
    {
        ...
        for (int i = 0; i < numChannels; ++i)
        {
            ...
            HAssert (dataToReferTo[i] != nullptr);
