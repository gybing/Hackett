...
public:
    ...
    */
    ...
    public:
        ...
        {
            HAssert (destSubChannel < destChannels && sourceSubChannel < sourceChannels);
    ...
    private:
        HDECLARE_NON_COPYABLE (ConverterInstance)
...
private:
    AudioDataConverters();
    HDECLARE_NON_COPYABLE (AudioDataConverters)
};
