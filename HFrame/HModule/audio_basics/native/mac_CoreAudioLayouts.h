...
struct CoreAudioLayouts
{
    ...
    //==============================================================================
    /** Convert CoreAudio's native AudioChannelLayout to H's AudioChannelSet.
    ...
    */
    ...
    /** Convert CoreAudio's native AudioChannelLayoutTag to H's AudioChannelSet.
    ...
    */
    ...
    /** Convert H's AudioChannelSet to CoreAudio's AudioChannelLayoutTag.
    ...
    */
    ...
    //==============================================================================
    /** Convert CoreAudio's native AudioChannelLayout to an array of H ChannelTypes. */
    static Array<AudioChannelSet::ChannelType> getCoreAudioLayoutChannels (const AudioChannelLayout& layout)
    {
        switch (layout.mChannelLayoutTag & 0xffff0000)
        {
            ...
            case kAudioChannelLayoutTag_UseChannelDescriptions:
            {
                ...
                // different speaker mappings may point to the same H speaker so fill up
    ...
    static Array<AudioChannelSet::ChannelType> getSpeakerLayoutForCoreAudioTag (AudioChannelLayoutTag tag)
    {
        ...
        HAssert (tag != kAudioChannelLayoutTag_UseChannelBitmap && tag != kAudioChannelLayoutTag_UseChannelDescriptions);
...
private:
    ...
    // Apple channel labels have been replaced by H channel names
    // This means that some layouts will be identical in H but not in CoreAudio

    // In Apple's official definition the following tags exist with the same speaker layout and order
    // even when *not* represented in H channels
