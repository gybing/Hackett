...
/**
    ...
    @tags{Audio}
*/
class API SynthesiserSound    : public ReferenceCountedObject
{
protected:
    //==============================================================================
    SynthesiserSound();
...
private:
    //==============================================================================
    HLEAK_DETECTOR (SynthesiserSound)
};
...
private:
    ...
    HLEAK_DETECTOR (SynthesiserVoice)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Synthesiser)
};
