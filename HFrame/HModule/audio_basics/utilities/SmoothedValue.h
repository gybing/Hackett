...
public:
    ...
    SmoothedValue (FloatType initialValue) noexcept
    {
        ...
        HAssert (! (std::is_same<SmoothingType, ValueSmoothingTypes::Multiplicative>::value && initialValue == 0));
    ...
    */
    ...
    {
        HAssert (sampleRate > 0 && rampLengthInSeconds >= 0);
    ...
    */
    void setTargetValue (FloatType newValue) noexcept
    {
        ...
        // Multiplicative smoothed values cannot ever reach 0!
        HAssert (! (std::is_same<SmoothingType, ValueSmoothingTypes::Multiplicative>::value && newValue == 0));
    ...
    */
    HDEPRECATED_WITH_BODY (void setValue (FloatType newValue, bool force = false) noexcept,
    {
        if (force)
        {
            this->setCurrentAndTargetValue (newValue);
