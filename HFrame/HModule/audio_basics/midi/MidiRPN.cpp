...
{
    HAssert (midiChannel >= 1 && midiChannel <= 16);
    HAssert (controllerNumber >= 0 && controllerNumber < 128);
    HAssert (controllerValue >= 0 && controllerValue < 128);
                                       ...
                                       bool use14BitValue)
{
    ...
    HAssert (parameterNumber >= 0 && parameterNumber < 16384);
    HAssert (value >= 0 && value < (use14BitValue ? 16384 : 128));
