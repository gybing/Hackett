...
/**
    ...
    @see Message, CallbackMessage, MessageManagerLock, HApplication, HApplicationBase

    @tags{Events}
*/
class API MessageManager  final
{
public:
    //==============================================================================
   ...
   #if HMODAL_LOOPS_PERMITTED || DOXYGEN
    ...
    */
    ...
    //==============================================================================
    /** Sends a message to all other H applications that are running.
    ...
    */
    ...
    /** Internal class used as the base class for all message objects.
        ...
        classes instead.
    */
    class API MessageBase  : public ReferenceCountedObject
    {
    public:
        MessageBase() = default;
        ...
        HDECLARE_NON_COPYABLE (MessageBase)
    };
        ...
        */
         ...
         */
         ...
         /** Attempts to lock the meesage manager and exits if abort is called.
            ...
            Unlike other H critical sections, this method **will** block waiting for the lock.
...
private:
    ...
    struct AsyncCallInvoker  : public MessageBase
    {
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AsyncCallInvoker)
    };

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MessageManager)
};
...
/** Used to make sure that the calling thread has exclusive access to the message loop.
    ...
    @tags{Events}
*/
class API MessageManagerLock      : private Thread::Listener
{
public:
    //==============================================================================
...
private:
    ...
    HDECLARE_NON_COPYABLE (MessageManagerLock)
};
...
*/
#define HASSERT_MESSAGE_MANAGER_IS_LOCKED \
    HAssert (MessageManager::existsAndIsLockedByCurrentThread());
...
/** This macro is used to catch unsafe use of functions which expect to only be called
    ...
    created, which could happen if you accidentally invoke it during a static constructor.
*/
#define HASSERT_MESSAGE_THREAD \
    HAssert (MessageManager::existsAndIsCurrentThread());
...
*/
#define HASSERT_MESSAGE_MANAGER_EXISTS \
