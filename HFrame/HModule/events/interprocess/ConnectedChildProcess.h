...
/**
    ...
    add some code to your main() or HApplication::initialise() function that
    ...
    The H demo app has a good example of this class in action.

    @see ChildProcessMaster, InterprocessConnection, ChildProcess

    @tags{Events}
*/
class API ChildProcessSlave
{
public:
    ...
    */
    ...
    /** This checks some command-line parameters to see whether they were generated by
        ...
        main() or HApplication::initialise() that calls this method.
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ChildProcessSlave)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ChildProcessMaster)
};
