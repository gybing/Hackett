...
public:
    ...
    ~TimerThread() override
    {
        ...
        stopThread (4000);
        HAssert (instance == this || instance == nullptr);
...
private:
    ...
    void addTimer (Timer* t)
    {
        ...
        HAssert (std::find_if (timers.begin(), timers.end(),
    ...
    void removeTimer (Timer* t)
    {
        ...
        HAssert (pos <= lastIndex);
        HAssert (timers[pos].timer == t);
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TimerThread)
};
...
void CALLTYPE Timer::callPendingTimersSynchronously()
{
...
struct LambdaInvoker  : private Timer
{
    ...
    HDECLARE_NON_COPYABLE (LambdaInvoker)
};

void CALLTYPE Timer::callAfterDelay (int milliseconds, std::function<void()> f)
{
