...
/**
    ...
    The deprecated constructor will be removed from the API in a future version of H!

    @tags{Audio}
*/
class API AudioProcessorValueTreeState   : private Timer,
...
public:
    ...
    */
    class API ParameterLayout final
    {
    private:
        //==============================================================================
    ...
    */
    ...
    /** This constructor is discouraged and will be deprecated in a future version of H!
    ...
    */
    ...
    //==============================================================================
    /** This function is deprecated and will be removed in a future version of H!
    ...
    */
    HDEPRECATED (RangedAudioParameter* createAndAddParameter (const String& parameterID,
    ...
    */
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SliderAttachment)
    };
    ...
    */
    ...
    private:
        struct Pimpl;
        std::unique_ptr<Pimpl> pimpl;
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ComboBoxAttachment)
    };
    ...
    */
    ...
    private:
        struct Pimpl;
        std::unique_ptr<Pimpl> pimpl;
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ButtonAttachment)
    };
...
private:
    ...
    /** This method was introduced to allow you to use AudioProcessorValueTreeState parameters in
        ...
        @endcode
        can instead create the APVTS like this, avoiding the two-step initialization process and leveraging one of H's
        ...
        @endcode
    */
    HDEPRECATED (std::unique_ptr<RangedAudioParameter> createParameter (const String&, const String&, const String&, NormalisableRange<float>,
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioProcessorValueTreeState)
};
