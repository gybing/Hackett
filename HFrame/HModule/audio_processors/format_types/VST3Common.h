...
//==============================================================================
#define HDECLARE_VST3_COM_REF_METHODS \
...
#define HDECLARE_VST3_COM_QUERY_METHODS \
...
//==============================================================================
inline String toString (const Steinberg::char8* string) noexcept      { return String (string); }
inline String toString (const Steinberg::char16* string) noexcept     { return String (CharPointer_UTF16 ((CharPointer_UTF16::CharType*) string)); }
...
inline Steinberg::Vst::TChar* toString (const String& source) noexcept
{
...
static inline AudioChannelSet::ChannelType getChannelType (Steinberg::Vst::SpeakerArrangement arr, Steinberg::Vst::Speaker type) noexcept
{
    ...
    // VST3 <-> H layout conversion error: report this bug to the H forum
    HAssert (channelType >= 33);
...
static inline AudioChannelSet getChannelSetForSpeakerArrangement (Steinberg::Vst::SpeakerArrangement arr) noexcept
{
    ...
    // VST3 <-> H layout conversion error: report this bug to the H forum
    HAssert (result.size() == vstChannels.countNumberOfSetBits());
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MidiEventList)
};
...
struct VST3BufferExchange
{
    ...
    */
                                   ...
                                   int sampleOffset = 0)
    {
        ...
        HAssert (channelEnd >= 0 && channelEnd <= buffer.getNumChannels());
