...
/**
    ...
    @tags{Audio}
*/
class API VSTPluginFormat   : public AudioPluginFormat
{
public:
    //==============================================================================
    VSTPluginFormat();
    ...
    */
    ...
    static pointer_sized_int CALLTYPE dispatcher (AudioPluginInstance*, int32, int32, pointer_sized_int, void*, float);

    /** Given a VstEffectInterface* (aka vst::AEffect*), this will return the H AudioPluginInstance
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (VSTPluginFormat)
};
