...
/**
    ...
    @tags{Audio}
*/
class API AudioProcessorGraph   : public AudioProcessor,
...
public:
    ...
    */
    class API Node   : public ReferenceCountedObject
    {
    public:
        //==============================================================================
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Node)
    };
    ...
    */
    class API AudioGraphIOProcessor     : public AudioPluginInstance
    {
    public:
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioGraphIOProcessor)
    };
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioProcessorGraph)
};
