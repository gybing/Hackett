...
/**
    ...
    @tags{Audio}
*/
class API AudioPluginFormat
{
public:
    //==============================================================================
    /** Structure used for callbacks when instantiation is completed. */
    struct API  InstantiationCompletionCallback
    {
        ...
        HLEAK_DETECTOR (InstantiationCompletionCallback)
    };
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioPluginFormat)
};
