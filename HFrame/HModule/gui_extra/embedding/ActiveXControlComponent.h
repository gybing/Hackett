...
/**
    ...
    @tags{GUI}
*/
class API ActiveXControlComponent   : public Component
{
public:
    //==============================================================================
    ...
    /** Tries to create an ActiveX control and embed it in this peer.
        ...
        as a void* because when including the H headers, you might not always
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ActiveXControlComponent)
};
