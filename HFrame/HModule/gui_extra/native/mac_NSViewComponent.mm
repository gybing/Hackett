...
private:
    ...
    {
        ViewFrameChangeCallbackClass()  : ObjCClass<NSObject> ("HNSViewCallback_")
        {
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE (ViewFrameChangeCallbackClass)
    };

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (NSViewResizeWatcher)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (NSViewAttachment)
};
