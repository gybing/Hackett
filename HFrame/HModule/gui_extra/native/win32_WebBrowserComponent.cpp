...
#if HMINGW
 HDECLARE_UUID_GETTER (IOleClientSite,           "00000118-0000-0000-c000-000000000046")
 HDECLARE_UUID_GETTER (IDispatch,                "00020400-0000-0000-c000-000000000046")
...
HDECLARE_UUID_GETTER (DWebBrowserEvents2,        "34A715A0-6587-11D0-924A-0020AFC7AC4D")
HDECLARE_UUID_GETTER (IConnectionPointContainer, "B196B284-BAB4-101A-B69C-00AA00341D07")
HDECLARE_UUID_GETTER (IWebBrowser2,              "D30C1661-CDAF-11D0-8A3E-00C04FC9E26E")
HDECLARE_UUID_GETTER (WebBrowser,                "8856F961-340A-11D0-A96B-00C04FD705A2")
...
private:
                           ...
                           public ComponentMovementWatcher
    {
        ...
        HCOMRESULT GetTypeInfoCount (UINT*)                                  { return E_NOTIMPL; }
        HCOMRESULT GetTypeInfo (UINT, LCID, ITypeInfo**)                     { return E_NOTIMPL; }
        HCOMRESULT GetIDsOfNames (REFIID, LPOLESTR*, UINT, LCID, DISPID*)    { return E_NOTIMPL; }

        HCOMRESULT Invoke (DISPID dispIdMember, REFIID /*riid*/, LCID /*lcid*/, WORD /*wFlags*/, DISPPARAMS* pDispParams,
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EventHandler)
    };
