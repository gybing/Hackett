...
/** Singleton class responsible for push notifications functionality. Both remote and
    ...
    @tags{GUI}
*/
class API PushNotifications    : private DeletedAtShutdown
{
public:
   #ifndef DOXYGEN
    HDECLARE_SINGLETON (PushNotifications, false)
   #endif
        ...
        */
        struct Action
        {
            ...
            String       icon;            /**< Optional: name of an icon file (without an extension) to be used for
                                                         ...
                                                         (see "Extra Android Raw Resources" setting in Projector).
        ...
        URL soundToPlay;     /**< Optional: empty when the notification should be silent. When the name is set to
                                  ...
                                  can use "Xcode Resource" tickbox in Projector to achieve that), i.e. it cannot be in a
                                  ...
                                  Projector (see "Extra Android Raw Resources" setting). */
...
private:
   ...
   #if HANDROID
    friend bool handleNotificationIntent (void*);
