...
/**
    ...
    @tags{GUI}
*/
class API ColourSelector  : public Component,
...
public:
    ...
    */
    ...
    //==============================================================================
    // These need to be public otherwise the Projector's live-build engine will complain
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ColourSelector)
