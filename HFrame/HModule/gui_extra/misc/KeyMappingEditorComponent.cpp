...
public:
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE (KeyEntryWindow)
    };
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ChangeKeyButton)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MappingItem)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CategoryItem)
};
