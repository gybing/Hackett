...
private:
    ...
    HDECLARE_NON_COPYABLE (ColourSpaceView)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE (HueSelectorComp)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE (SwatchComponent)
};
      ...
      edgeGap (edge)
{
    ...
    HAssert ((flags & (showColourAtTop | showSliders | showColourspace)) != 0);
...
{
    HAssertfalse; // if you've overridden getNumSwatches(), you also need to implement this method
