...
#if HWINDOWS || HLINUX || HMAC || DOXYGEN
...
/**
    ...
    @tags{GUI}
*/
class API SystemTrayIconComponent  : public Component
{
public:
    //==============================================================================
    /** Constructor. */
...
private:
    ...
    HDEPRECATED (void setIconImage (const Image& newImage));

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SystemTrayIconComponent)
};
