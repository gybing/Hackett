...
/** A component for showing a splash screen while your app starts up.
    ...
    To use it, just create one of these in your HApplicationBase::initialise() method,
    ...
    @tags{GUI}
*/
class API SplashScreen  : public Component,
                                private Timer,
...
public:
    ...
    /** Creates a SplashScreen object.
        ...
        Bear in mind that if you call this during your HApplicationBase::initialise()
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SplashScreen)
};
