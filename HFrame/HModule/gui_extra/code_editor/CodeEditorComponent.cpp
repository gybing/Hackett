...
public:
    ...
    {
        HAssert (dynamic_cast<CodeEditorComponent*> (getParentComponent()) != nullptr);
...
{
    HAssertfalse; // TODO Windows IME not yet supported for this comp..
}
