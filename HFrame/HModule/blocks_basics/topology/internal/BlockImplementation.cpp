...
public:
    ...
    Array<Block::ConnectionPort> getPorts() const override    { return modelData.ports; }
    ...
    Array<ControlButton*> getButtons() const override
    {
        Array<ControlButton*> result;
        result.addArray (controlButtons);
        return result;
    }

    Array<StatusLight*> getStatusLights() const override
    {
        Array<StatusLight*> result;
    ...
    {
        HAssert (dynamic_cast<BlockImplementation*> (b) != nullptr);
    ...
    {
        HAssert (isPositiveAndNotGreaterThan (programSize, modelData.programAndHeapSize));
...
private:
    ...
    {
        HAssert (listenerToMidiConnection == &c);
        ignoreUnused (c);
        disconnectMidiConnectionListener();
    }
...
public:
                                         ...
                                         private Timer
    {
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TouchSurfaceImplementation)
    };
    ...
    struct ControlButtonImplementation  : public ControlButton
    {
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ControlButtonImplementation)
    };
    ...
    struct StatusLightImplementation  : public StatusLight
    {
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (StatusLightImplementation)
    };
    ...
    struct LEDGridImplementation  : public LEDGrid
    {
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LEDGridImplementation)
    };
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LEDRowImplementation)
    };

private:
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BlockImplementation)
};
