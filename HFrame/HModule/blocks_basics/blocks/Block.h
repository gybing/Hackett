...
public:
    ...
    */
    virtual Array<StatusLight*> getStatusLights() const = 0;
    ...
    */
    ...
    /** If this block has any control buttons, this will return an array of objects to control them.
        ...
        neither delete them or use them after the lifetime of this Block object has finished.
    */
    virtual Array<ControlButton*> getButtons() const = 0;

    //==============================================================================
    /** This returns true if the block supports generating graphics by drawing into a H
    ...
    */
    ...
    virtual Array<ConnectionPort> getPorts() const = 0;
    ...
    struct Program
    {
        ...
        virtual Array<File> getSearchPaths() { return {}; }
...
private:
    //==============================================================================
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Block)
};
