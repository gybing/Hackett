...
public:
    ...
    void processFullBlock (const void* const data) noexcept
    {
        ...
        for (uint32 j = 0; j < 64; j += 16)
        {
            ...
            HSHA256(0);  HSHA256(1);  HSHA256(2);  HSHA256(3);  HSHA256(4);  HSHA256(5);  HSHA256(6);  HSHA256(7);
            HSHA256(8);  HSHA256(9);  HSHA256(10); HSHA256(11); HSHA256(12); HSHA256(13); HSHA256(14); HSHA256(15);
            #undef HSHA256
        }
    ...
    void processFinalBlock (const void* const data, unsigned int numBytes) noexcept
    {
        ...
        HAssert (numBytes == 64 || numBytes == 128);
...
private:
    ...
    HDECLARE_NON_COPYABLE (SHA256Processor)
};
