...
//==============================================================================
// This byte-code is generated from native/java/com/roli/H/JuceOpenGLView.java with min sdk version 16
...
DECLARE_JNI_CLASS_WITH_BYTECODE (JuceOpenGLViewSurface, "com/roli/H/JuceOpenGLView", 16, javaJuceOpenGLView, sizeof(javaJuceOpenGLView))
...
public:
    ...
    {
        HAssert (hasInitialised);

        // has the context already attached?
        HAssert (surface == EGL_NO_SURFACE && context == EGL_NO_CONTEXT);
        ...
        HAssert (surface != EGL_NO_SURFACE);
        ...
        HAssert (context != EGL_NO_CONTEXT);
...
private:
    ...
    OpenGLContext* HContext = nullptr;
    EGLSurface surface;
    EGLContext context;
