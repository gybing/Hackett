...
//==============================================================================
// Defined linux_Windowing.cpp
Rectangle<int> LinuxScaledToPhysicalBounds (ComponentPeer*, Rectangle<int>);
void LinuxAddRepaintListener (ComponentPeer*, Component* dummy);
void LinuxRemoveRepaintListener (ComponentPeer*, Component* dummy);
...
public:
        ...
        : component (comp), contextToShareWith (shareContext), dummy (*this)
    {
        ...
        glBounds = LinuxScaledToPhysicalBounds (peer, glBounds);
        ...
        LinuxAddRepaintListener (peer, &dummy);
    }

    ~NativeContext()
    {
        LinuxRemoveRepaintListener (component.getPeer(), &dummy);
    ...
    {
        bounds = newBounds;
        auto physicalBounds = LinuxScaledToPhysicalBounds (component.getPeer(), bounds);
