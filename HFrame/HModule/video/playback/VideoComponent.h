...
#ifndef HVIDEOCOMPONENT_H_INCLUDED
#define HVIDEOCOMPONENT_H_INCLUDED
...
/**
    ...
    @tags{Video}
*/
class API VideoComponent  : public Component,
                                  private Timer
{
public:
    //==============================================================================
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (VideoComponent)
};
