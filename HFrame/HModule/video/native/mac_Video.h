...
struct VideoComponent::Pimpl   : public Base
{
    ...
    {
        auto r = load ([NSURL URLWithString: HStringToNS (url.toString (true))]);
...
private:
    ...
    protected:
        ...
        public:
            ...
            {
                auto nsUrl = [NSURL URLWithString: HStringToNS (url.toString (true))];
        ...
        private:
            ...
            void checkAllKeysReadyFor (AVAsset* assetToCheck, const URL& url)
            {
                ...
                HAssert (successCount == (int) [assetKeys.get() count]);
                preparePlayerItem();
            }
            ...
            HDECLARE_WEAK_REFERENCEABLE (PlayerAsyncInitialiser)
        };
    ...
    private:
        ...
        HDECLARE_WEAK_REFERENCEABLE (PlayerControllerBase)
    };
