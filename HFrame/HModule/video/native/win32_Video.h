...
namespace VideoRenderers
{
    ...
    struct VMR7  : public Base
    {
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (VMR7)
    };
    ...
    struct EVR  : public Base
    {
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EVR)
    };
};
...
private:
    ...
    struct ComponentWatcher   : public ComponentMovementWatcher
    {
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ComponentWatcher)
    };
    ...
    struct DirectShowContext    : public AsyncUpdater
    {
        ...
        {
            HAssert (state == uninitializedState);
    ...
    private:
        ...
        struct NativeWindowClass   : private DeletedAtShutdown
        {
            ...
            HDECLARE_SINGLETON_SINGLETHREADED_MINIMAL (NativeWindowClass)

        private:
            NativeWindowClass()
            {
                String windowClassName ("HDIRECTSHOW_");
            ...
            HDECLARE_NON_COPYABLE (NativeWindowClass)
        };
        ...
        struct NativeWindow
        {
            ...
            HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (NativeWindow)
        };

        std::unique_ptr<NativeWindow> nativeWindow;

        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DirectShowContext)
    };
...
HIMPLEMENT_SINGLETON (VideoComponent::Pimpl::DirectShowContext::NativeWindowClass)
