...
private:
   ...
   #if HANDROID
    friend void cameraDeviceStateClosed (int64);
    friend void cameraDeviceStateDisconnected (int64);
    friend void cameraDeviceStateError (int64, int);
    friend void cameraDeviceStateOpened (int64, void*);

    friend void cameraCaptureSessionActive (int64, void*);
    friend void cameraCaptureSessionClosed (int64, void*);
    friend void cameraCaptureSessionConfigureFailed (int64, void*);
    friend void cameraCaptureSessionConfigured (int64, void*);
    friend void cameraCaptureSessionReady (int64, void*);

    friend void cameraCaptureSessionCaptureCompleted (int64, bool, void*, void*, void*);
    friend void cameraCaptureSessionCaptureFailed (int64, bool, void*, void*, void*);
    friend void cameraCaptureSessionCaptureProgressed (int64, bool, void*, void*, void*);
    friend void cameraCaptureSessionCaptureSequenceAborted (int64, bool, void*, int);
    friend void cameraCaptureSessionCaptureSequenceCompleted (int64, bool, void*, int, int64);
    friend void cameraCaptureSessionCaptureStarted (int64, bool, void*, void*, int64, int64);

    friend void deviceOrientationChanged (int64, int);
   #endif

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CameraDevice)
};
