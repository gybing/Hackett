...
extern AudioProcessor* API CALLTYPE createPluginFilterOfType (AudioProcessor::WrapperType type);
...
public:
    ...
    */
    ...
    virtual void createPlugin()
    {
      ...
      #endif
        HAssert (processor != nullptr); // Your createPluginFilter() function must return a valid object!
...
private:
    ...
    private:
        ...
        //==============================================================================
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SettingsComponent)
    };
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (StandalonePluginHolder)
};
...
/**
    ...
    Just create one of these objects in your HApplicationBase::initialise() method, and
...
private:
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MainContentComponent)
    };

    //==============================================================================
    TextButton optionsButton;

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (StandaloneFilterWindow)
};
