...
public:
    ...
    enum HostType
    {
        ...
        HPluginHost,             /**< Represents the H AudioPluginHost */
    ...
    /** Returns true if the host is the H AudioPluginHost */
    bool isHPluginHost() const noexcept    { return type == HPluginHost; }
    ...
    const char* getHostDescription() const noexcept
    {
        switch (type)
        {
            ...
            case HPluginHost:           return "H AudioPluginHost";
    ...
    */
    static AudioProcessor::WrapperType getPluginLoadedAs() noexcept    { return HPlugInClientCurrentWrapperType; }
   ...
   #ifndef DOXYGEN
    // @internal
    static AudioProcessor::WrapperType HPlugInClientCurrentWrapperType;
    static std::function<bool(AudioProcessor&)> HPlugInIsRunningInAudioSuiteFn;
   #endif
...
private:
    static HostType getHostType()
    {
        ...
        if (hostFilename.containsIgnoreCase   ("AudioPluginHost"))   return HPluginHost;
