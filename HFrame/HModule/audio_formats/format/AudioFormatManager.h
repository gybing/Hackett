...
public:
    ...
    */
    ...
    /** Handy method to make it easy to register the formats that come with H.
        This will add WAV and AIFF to the list, along with any other formats enabled
        in either the Projector or your application's AppConfig.h.
    */
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioFormatManager)
};
