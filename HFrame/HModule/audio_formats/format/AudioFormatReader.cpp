...
{
    HAssert (numDestChannels > 0); // you have to actually give this some channels to work with!
                              ...
                              bool useReaderRightChan)
{
    ...
    HAssert (startSample >= 0 && startSample + numSamples <= buffer->getNumSamples());
...
{
    HAssert (channelsToRead > 0 && channelsToRead <= (int) numChannels);
                                         ...
                                         int minimumConsecutiveSamples)
{
    ...
    HAssert (magnitudeRangeMaximum > magnitudeRangeMinimum);
