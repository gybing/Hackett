...
struct MP3Frame
{
    ...
    void decodeHeader (const uint32 header)
    {
        ...
        if (bitrateIndex == 0)
        {
            HAssertfalse; // This means the file is using "free format". Apparently very few decoders
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MP3Stream)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MP3Reader)
};
