...
#if HUSE_OGGVORBIS || defined (DOXYGEN)

//==============================================================================
/**
    Reads and writes the Ogg-Vorbis audio format.

    To compile this, you'll need to set the HUSE_OGGVORBIS flag.

    @see AudioFormat,

    @tags{Audio}
*/
class API OggVorbisAudioFormat  : public AudioFormat
{
public:
    //==============================================================================
...
private:
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OggVorbisAudioFormat)
};
