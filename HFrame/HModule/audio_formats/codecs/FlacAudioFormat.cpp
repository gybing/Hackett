...
{
#if HINCLUDE_FLAC_CODE || ! defined (HINCLUDE_FLAC_CODE)
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FlacReader)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FlacWriter)
};
