...
public:
    ...
    HCOMRESULT Commit (DWORD)                        { return S_OK; }
    HCOMRESULT Write (const void*, ULONG, ULONG*)    { return E_NOTIMPL; }
    HCOMRESULT Clone (IStream**)                     { return E_NOTIMPL; }
    HCOMRESULT SetSize (ULARGE_INTEGER)              { return E_NOTIMPL; }
    HCOMRESULT Revert()                              { return E_NOTIMPL; }
    HCOMRESULT LockRegion (ULARGE_INTEGER, ULARGE_INTEGER, DWORD)    { return E_NOTIMPL; }
    HCOMRESULT UnlockRegion (ULARGE_INTEGER, ULARGE_INTEGER, DWORD)  { return E_NOTIMPL; }

    HCOMRESULT Read (void* dest, ULONG numBytes, ULONG* bytesRead)
    {
    ...
    HCOMRESULT Seek (LARGE_INTEGER position, DWORD origin, ULARGE_INTEGER* resultPosition)
    {
    ...
    HCOMRESULT CopyTo (IStream* destStream, ULARGE_INTEGER numBytesToDo,
    ...
    HCOMRESULT Stat (STATSTG* stat, DWORD)
    {
        if (stat == nullptr)
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (JuceIStream)
};
...
public:
    ...
    {
        HLOAD_WINAPI_FUNCTION (wmvCoreLib, WMCreateSyncReader, wmCreateSyncReader,
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (WMAudioReader)
};
...
{
    HAssertfalse; // not yet implemented!
    return nullptr;
}
