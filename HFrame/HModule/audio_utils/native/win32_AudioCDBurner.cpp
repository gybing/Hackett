...
public:
    ...
    HCOMRESULT QueryCancel (boolean* pbCancel)
    {
    ...
    HCOMRESULT NotifyBlockProgress (long nCompleted, long nTotal)
    {
    ...
    HCOMRESULT NotifyPnPActivity (void)                              { return E_NOTIMPL; }
    HCOMRESULT NotifyAddProgress (long /*nCompletedSteps*/, long /*nTotalSteps*/)    { return E_NOTIMPL; }
    HCOMRESULT NotifyTrackProgress (long /*nCurrentTrack*/, long /*nTotalTracks*/)   { return E_NOTIMPL; }
    HCOMRESULT NotifyPreparingBurn (long /*nEstimatedSeconds*/)      { return E_NOTIMPL; }
    HCOMRESULT NotifyClosingDisc (long /*nEstimatedSeconds*/)        { return E_NOTIMPL; }
    HCOMRESULT NotifyBurnComplete (HRESULT /*status*/)               { return E_NOTIMPL; }
    HCOMRESULT NotifyEraseComplete (HRESULT /*status*/)              { return E_NOTIMPL; }
    ...
    private:
        ...
        HDECLARE_NON_COPYABLE (ScopedDiscOpener)
    };
