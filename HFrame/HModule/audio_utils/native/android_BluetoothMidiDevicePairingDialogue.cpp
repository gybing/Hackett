...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK) \
 STATICMETHOD (getAndroidBluetoothManager, "getAndroidBluetoothManager", "(Landroid/content/Context;)Lcom/roli/H/JuceMidiSupport$BluetoothManager;")

DECLARE_JNI_CLASS_WITH_MIN_SDK (AndroidJuceMidiSupport, "com/roli/H/JuceMidiSupport", 23)
...
DECLARE_JNI_CLASS_WITH_MIN_SDK (AndroidBluetoothManager, "com/roli/H/JuceMidiSupport$BluetoothManager", 23)
#undef JNI_CLASS_MEMBERS
...
private:
                               ...
                               private AsyncUpdater
    {
        PairDeviceThread (const String& bluetoothAddressOfDeviceToPair,
            ...
            : Thread ("H Bluetooth MIDI Device Pairing Thread"),
