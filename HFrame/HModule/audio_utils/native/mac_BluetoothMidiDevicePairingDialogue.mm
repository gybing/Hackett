...
public:
    ...
    BluetoothMidiPairingWindowClass()   : ObjCClass<NSObject> ("HBluetoothMidiPairingWindowClass_")
    {
...
private:
    ...
    HDECLARE_WEAK_REFERENCEABLE (BluetoothMidiSelectorWindowHelper)
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BluetoothMidiSelectorWindowHelper)
};
