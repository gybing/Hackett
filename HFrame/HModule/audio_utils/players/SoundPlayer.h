...
/**
    ...
    @tags{Audio}
*/
class API SoundPlayer   : public AudioIODeviceCallback
{
public:
    //==============================================================================
    SoundPlayer();
    ...
    /** Convenient method to play sound from a H resource. */
    ...
    /** Plays the sound from a positionable audio source.
        ...
        @param deleteWhenFinished If this is true then the audio source will
                                  ...
                                  playing.
        @param sampleRateOfSource The sample rate of the source. If this is zero, H
...
private:
    ...
    //==============================================================================
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SoundPlayer)
};
