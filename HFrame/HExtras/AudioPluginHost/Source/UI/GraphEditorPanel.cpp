...
//==============================================================================
 ...
 private:
     ...
     struct ScanJob  : public ThreadPoolJob
     {
         ...
         HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ScanJob)
     };

     HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AUScanner)
 };
#endif
                                          ...
                                          public SettableTooltipClient
{
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PinComponent)
};
                                                ...
                                                public SettableTooltipClient
{
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ConnectorComponent)
};
                                              ...
                                              private Timer
{
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TooltipBar)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TitleBarComponent)
};
                                                       ...
                                                       public MouseListener
{
    ...
    HDECLARE_NON_COPYABLE (PluginListBoxModel)
};
...
void GraphDocumentComponent::itemDropped (const SourceDetails& details)
{
    ...
    HAssert (isPositiveAndBelow (pluginTypeIndex, pluginList.getNumTypes()));
