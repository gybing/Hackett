...
private:
    ...
    HCONSTEXPR static const int maxLogSize = 300;
    HCONSTEXPR static const int logSizeTrimThreshold = 400;
...
private:
    ...
    private:
                               ...
                               private AudioProcessorListener
        {
            ...
            HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PropertyComp)
        };

        PropertyPanel panel;

        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ProgramAudioProcessorEditor)
    };

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PluginWindow)
};
