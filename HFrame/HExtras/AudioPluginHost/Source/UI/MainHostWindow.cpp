...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PluginListWindow)
};

//==============================================================================
MainHostWindow::MainHostWindow()
    : DocumentWindow (HApplication::getInstance()->getApplicationName(),
                      LookAndFeel::getDefaultLookAndFeel().findColour (ResizableWindow::backgroundColourId),
...
void MainHostWindow::changeListenerCallback (ChangeBroadcaster* changed)
{
    ...
    {
        auto title = HApplication::getInstance()->getApplicationName();
