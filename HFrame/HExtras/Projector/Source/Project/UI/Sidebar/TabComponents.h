...
public:
    ...
    void paint (Graphics& g) override
    {
        ...
        g.fillPath (arrowPath = ProjectorLookAndFeel::getArrowPath (arrowBounds,
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ConcertinaHeader)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FindPanel)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ConcertinaTreeComponent)
};
