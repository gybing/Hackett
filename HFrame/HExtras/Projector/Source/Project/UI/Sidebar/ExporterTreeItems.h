...
private:
    ...
    struct SettingsComp  : public Component
    {
        ...
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SettingsComp)
    };

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ExporterItem)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ConfigItem)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ExportersTreeRoot)
};
