                                   ...
                                   private ChangeListener
{
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ProjectSettingsComponent)
};
...
public:
    ...
    {
        HAssert (isPositiveAndBelow (panelIndex, concertinaPanel.getNumPanels()));
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ProjectTab)
};
