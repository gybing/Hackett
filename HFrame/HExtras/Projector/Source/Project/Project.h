...
public:
    ...
    private:
        Project& project;
        HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ExporterIterator)
    };
...
private:
    ValueTree projectRoot  { Ids::HRPROJECT };
    ...
    void warnAboutOldProjectorVersion();

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Project)
};
