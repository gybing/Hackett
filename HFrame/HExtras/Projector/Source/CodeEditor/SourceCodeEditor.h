...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SourceCodeEditor)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (GenericCodeEditorComponent)
};
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CppCodeEditorComponent)
};
