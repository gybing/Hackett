...
private:
    //==============================================================================
    struct LabelLookAndFeel : public ProjectorLookAndFeel
    {
    ...
    {
        labelToDisplay.setColour (Label::textColourId, ProjectorApplication::getApp().lookAndFeel.findColour (defaultTextColourId));
    }
