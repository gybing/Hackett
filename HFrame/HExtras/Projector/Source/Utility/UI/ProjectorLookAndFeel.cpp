...
#include "ProjectorLookAndFeel.h"
#include "../../Application/Application.h"

//==============================================================================
ProjectorLookAndFeel::ProjectorLookAndFeel()
{
    setupColours();
}
...
void ProjectorLookAndFeel::drawTabButton (TabBarButton& button, Graphics& g, bool isMouseOver, bool isMouseDown)
{
...
int ProjectorLookAndFeel::getTabButtonBestWidth (TabBarButton& button, int)
{
...
void ProjectorLookAndFeel::drawPropertyComponentLabel (Graphics& g, int width, int height, PropertyComponent& component)
{
    ignoreUnused (width);
...
Rectangle<int> ProjectorLookAndFeel::getPropertyComponentContentPosition (PropertyComponent& component)
{
    const auto textW = getTextWidthForPropertyComponent (&component);
    return { textW, 0, component.getWidth() - textW, component.getHeight() - 1 };
}

void ProjectorLookAndFeel::drawButtonBackground (Graphics& g,
                                                Button& button,
...
void ProjectorLookAndFeel::drawButtonText (Graphics& g, TextButton& button, bool isMouseOverButton, bool isButtonDown)
{
...
void ProjectorLookAndFeel::drawToggleButton (Graphics& g, ToggleButton& button, bool isMouseOverButton, bool isButtonDown)
{
    ignoreUnused (isMouseOverButton, isButtonDown);
...
void ProjectorLookAndFeel::fillTextEditorBackground (Graphics& g, int width, int height, TextEditor& textEditor)
{
...
void ProjectorLookAndFeel::layoutFileBrowserComponent (FileBrowserComponent& browserComp,
...
void ProjectorLookAndFeel::drawFileBrowserRow (Graphics& g, int width, int height,
...
void ProjectorLookAndFeel::drawCallOutBoxBackground (CallOutBox&, Graphics& g, const Path& path, Image&)
{
...
void ProjectorLookAndFeel::drawMenuBarBackground (Graphics& g, int width, int height,
...
void ProjectorLookAndFeel::drawMenuBarItem (Graphics& g, int width, int height,
...
void ProjectorLookAndFeel::drawResizableFrame (Graphics& g, int w, int h, const BorderSize<int>& border)
{
    ignoreUnused (g, w, h, border);
}

void ProjectorLookAndFeel::drawComboBox (Graphics& g, int width, int height, bool,
...
void ProjectorLookAndFeel::drawTreeviewPlusMinusBox (Graphics& g, const Rectangle<float>& area,
...
void ProjectorLookAndFeel::drawProgressBar (Graphics& g, ProgressBar& progressBar,
...
//==============================================================================
Path ProjectorLookAndFeel::getArrowPath (Rectangle<float> arrowZone, const int direction,
                                        bool filled, const Justification justification)
{
    ...
    {
        HAssertfalse; // currently only supports centred justifications
    }
...
Path ProjectorLookAndFeel::getChoiceComponentArrowPath (Rectangle<float> arrowZone)
{
...
//==============================================================================
void ProjectorLookAndFeel::setupColours()
{
    auto& colourScheme = getCurrentColourScheme();

    if (colourScheme == getDarkColourScheme() || colourScheme == getProjectorDarkColourScheme())
    {
        ...
        colourScheme = getProjectorDarkColourScheme();
    }
