...
//==============================================================================
class ProjectorLookAndFeel   : public LookAndFeel_V4
{
public:
    ProjectorLookAndFeel();
    ~ProjectorLookAndFeel() override;
    ...
    static ColourScheme getProjectorDarkColourScheme()
    {
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ProjectorLookAndFeel)
};
