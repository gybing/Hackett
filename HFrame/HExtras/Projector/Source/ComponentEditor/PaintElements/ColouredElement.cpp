...
#include "GradientPointComponent.h"
#include "../Properties/PositionPropertyBase.h"
#include "../Properties/ColourPropertyComponent.h"
#include "PaintElementUndoableAction.h"
#include "PaintElementPath.h"
#include "ImageResourceProperty.h"
...
public:
    ...
    {
        HAssertfalse; // option shouldn't be visible
    }
