...
#include "../UI/ComponentOverlayComponent.h"
#include "ComponentNameProperty.h"
#include "../Properties/PositionPropertyBase.h"
...
{
    HAssert (getHandlerFor (existing) == this);
...
{
    HAssert (xml.hasTagName (getXmlTagName()));
...
int64 ComponentTypeHandler::getComponentId (Component* comp)
{
    ...
    int64 compId = comp->getProperties() ["HrCompId"].toString().getHexValue64();
