...
{
    HAssert (components [oldIndex] != nullptr);
...
void ComponentLayout::setComponentRelativeTarget (Component* comp, int whichDimension, Component* compToBeRelativeTo)
{
    ...
    HAssert (comp != nullptr);
    HAssert (pe != nullptr || components.contains (comp));
    HAssert (compToBeRelativeTo == nullptr || components.contains (compToBeRelativeTo));
    HAssert (compToBeRelativeTo == nullptr || ! dependsOnComponentForRelativePos (compToBeRelativeTo, comp));
