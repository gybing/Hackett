...
#include "../../Settings/AppearanceSettings.h"
#include "../../Application/Application.h"
#include "JucerDocumentEditor.h"
#include "TestComponent.h"
#include "../ObjectTypes.h"
#include "ComponentLayoutPanel.h"
#include "PaintRoutinePanel.h"
#include "ResourceEditorPanel.h"
#include "../Properties/ComponentTextProperty.h"
#include "../Properties/ComponentChoiceProperty.h"
#include "../UI/JucerCommandIDs.h"
    ...
    if (document != nullptr)
    {
        ...
        if (auto* project = document->getCppDocument().getProject())
        {
            if (project->shouldSendGUIBuilderAnalyticsEvent())
                Analytics::getInstance()->logEvent ("GUI Builder", {}, ProjectorAnalyticsEvent::projectEvent);
        }
    }
}
...
bool JucerDocumentEditor::keyPressed (const KeyPress& key)
{
    ...
    {
        ProjectorApplication::getCommandManager().invokeDirectly (StandardApplicationCommandIDs::del, true);
        return true;
    }
...
JucerDocumentEditor* JucerDocumentEditor::getActiveDocumentHolder()
{
    ...
    return dynamic_cast<JucerDocumentEditor*> (ProjectorApplication::getCommandManager()
...
{
    auto* commandManager = &ProjectorApplication::getCommandManager();
...
void registerGUIEditorCommands()
{
    ...
    ProjectorApplication::getCommandManager().registerAllCommandsForTarget (&dh);
}
