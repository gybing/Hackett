...
PaintRoutine::PaintRoutine()
    : document (nullptr),
      backgroundColour (ProjectorApplication::getApp().lookAndFeel.findColour (backgroundColourId))
{
    clear();
}
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AddXmlElementAction)
};
...
{
    HAssert (elements [oldIndex] != nullptr);
