...
public:
    ...
    public:
        ...
        void addFilesToCompile (const Project::Item& projectItem, XmlElement& cpps, XmlElement& headers, XmlElement& otherFiles) const
        {
                     ...
                     && getOwner().getProject().getTargetTypeFromFilePath (projectItem.getFile(), true) == targetType)
            {
                ...
                HAssert (path.getRoot() == RelativePath::buildTargetFolder);
                              ...
                              XmlElement& cpps, XmlElement& headers, XmlElement& otherFiles) const
        {
            ...
            HAssert (file.getRoot() == RelativePath::buildTargetFolder);
                               ...
                               XmlElement& cpps, XmlElement& headers, XmlElement& otherFiles, XmlElement& groups) const
        {
            ...
            else if (projectItem.shouldBeAddedToTargetProject())
            {
                ...
                HAssert (relativePath.getRoot() == RelativePath::buildTargetFolder);
        ...
        String getModuleDefinitions (const MSVCBuildConfiguration& config) const
        {
            ...
            if (type == RTASPlugIn)
            {
                ...
                auto moduleDefPath
                    = RelativePath (exp.getPathForModuleString ("audio_plugin_client"), RelativePath::projectFolder)
                         .getChildFile ("audio_plugin_client").getChildFile ("RTAS").getChildFile ("RTAS_WinExports.def");
    ...
    void createExporterProperties (PropertyListBuilder& props) override
    {
        props.add (new TextPropertyComponent (manifestFileValue, "Manifest file", 8192, false),
            "Path to a manifest input file which should be linked into your binary (path is relative to Hr file).");
    }
    ...
    static void createRCFile (const Project& project, const File& iconFile, const File& rcFile)
    {
        ...
        mo << "#ifdef HUSER_DEFINED_RC_FILE" << newLine
           << " #include HUSER_DEFINED_RC_FILE" << newLine
           << "#else" << newLine
           << newLine
...
protected:
    ...
    static void writeIconFile (const Array<Image>& images, MemoryOutputStream& out)
    {
        ...
        HAssert (out.getPosition() == dataBlockStart);
        out << dataBlock;
    }
    ...
    {
        return path.getFileNameWithoutExtension().startsWithIgnoreCase ("include_audio_plugin_client_RTAS_");
    }
    ...
    HDECLARE_NON_COPYABLE (MSVCProjectExporterBase)
};
...
public:
    ...
    HDECLARE_NON_COPYABLE (MSVCProjectExporterVC2013)
};
...
public:
    ...
    HDECLARE_NON_COPYABLE (MSVCProjectExporterVC2015)
};
...
public:
    ...
    HDECLARE_NON_COPYABLE (MSVCProjectExporterVC2017)
};
...
public:
    ...
    HDECLARE_NON_COPYABLE (MSVCProjectExporterVC2019)
};
