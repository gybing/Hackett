...
#include "../../Utility/UI/PropertyComponents/ColourPropertyComponent.h"
...
private:
        ...
        private:
            ...
            void saveScheme (bool isExit)
            {
                ...
                if (fc.browseForFileToSave (true))
                {
                    ...
                    saveSchemeState();
                    ProjectorApplication::getApp().selectEditorColourSchemeWithName (file.getFileNameWithoutExtension());
                }
                else if (isExit)
                {
            ...
            HDECLARE_NON_COPYABLE (EditorPanel)
        };
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EditorColourSchemeWindowComponent)
};
