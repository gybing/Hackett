...
public:
    AboutWindowComponent()
    {
        ...
        versionLabel.setText ("H v" + ProjectorApplication::getApp().getApplicationVersion()
    ...
    void resized() override
    {
        ...
        //======================================================================
        HLogoBounds = leftSlice.removeFromTop (150).toFloat();
        HLogoBounds.setWidth (HLogoBounds.getWidth() + 100);
        HLogoBounds.setHeight (HLogoBounds.getHeight() + 100);
    ...
    void paint (Graphics& g) override
    {
        ...
        if (HLogo != nullptr)
            HLogo->drawWithin (g, HLogoBounds.translated (-75, -75), RectanglePlacement::centred, 1.0);
...
private:
    ...
    Rectangle<float> huckleberryLogoBounds, HLogoBounds;

    std::unique_ptr<Drawable> HLogo { Drawable::createFromImageData (BinaryData::icon_png,
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AboutWindowComponent)
};
