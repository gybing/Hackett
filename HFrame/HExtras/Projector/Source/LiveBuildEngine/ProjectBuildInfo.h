...
struct ProjectBuildInfo
{
    ...
    String getJuceModulesFolder() const             { return tree [Ids::HModulesFolder]; }
    void setJuceModulesFolder (const String& s)     { tree.setProperty (Ids::HModulesFolder, s, nullptr); }
