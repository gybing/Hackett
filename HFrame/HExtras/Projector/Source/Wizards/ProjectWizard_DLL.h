...
struct DynamicLibraryWizard   : public NewProjectWizard
{
    ...
    String getDescription() const override  { return TRANS("Creates a Dynamic Library template with support for all H features."); }
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DynamicLibraryWizard)
};
