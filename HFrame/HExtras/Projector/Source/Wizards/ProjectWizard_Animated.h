...
struct AnimatedAppWizard   : public NewProjectWizard
{
    ...
    bool initialiseProject (Project& project) override
    {
        ...
        String windowH = project.getFileTemplate (createCppFile ? "AnimatedComponentTemplate_h"
                                                                : "AnimatedComponentSimpleTemplate_h")
        ...
        if (createCppFile)
        {
            String windowCpp = project.getFileTemplate ("AnimatedComponentTemplate_cpp")
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AnimatedAppWizard)
};
