...
private:
    void clicked() override
    {
        ...
        Analytics::getInstance()->logEvent ("Start Page Button", data, ProjectorAnalyticsEvent::startPageEvent);
    }

    std::unique_ptr<Drawable> thumb, hoverBackground;
    String name, description;

    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TemplateOptionButton)
};
...
private:
    ...
    TemplateOptionButton blankProjectButton   { "Create Blank Project",  TemplateOptionButton::ImageOnButtonBackground, BinaryData::wizard_Openfile_svg },
                         ...
                         browseDemosButton    { "Browse H Demos",     TemplateOptionButton::ImageOnButtonBackground, BinaryData::wizard_Openfile_svg },
                         viewTutorialsButton  { "View H Tutorials",   TemplateOptionButton::ImageOnButtonBackground, BinaryData::wizard_Openfile_svg };
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TemplateTileBrowser)
};
