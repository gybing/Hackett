...
public:
          ...
          useGlobalPathsToggle ("Use global module path")
    {
        ...
        openFolderButton.setTooltip (TRANS ("Select H modules folder"));
    ...
    static bool selectJuceFolder (File& result)
    {
        for (;;)
        {
            FileChooser fc ("Select your H modules folder...",
            ...
            if (isHModulesFolder (fc.getResult()))
            {
                result = fc.getResult();
                return true;
            }
            ...
            AlertWindow::showMessageBox (AlertWindow::WarningIcon,
                                         "Not a valid H modules folder!",
                                         "Please select the folder containing your * modules!\n\n"
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PlatformTargetsComp)
};
...
public:
    ...
    void createProject()
    {
        ...
        if (wizard != nullptr)
        {
            ...
            if (! isHModulesFolder (wizard->modulesFolder))
            {
                if (modulesPathBox.isUsingGlobalPaths)
                    AlertWindow::showMessageBox (AlertWindow::AlertIconType::WarningIcon, "Invalid Global Path",
                                                 "Your global H module search path is invalid. Please select the folder containing your H modules "
