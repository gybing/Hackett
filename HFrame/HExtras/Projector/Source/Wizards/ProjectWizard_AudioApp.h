...
struct AudioAppWizard   : public NewProjectWizard
{
    ...
    String getDescription() const override  { return TRANS("Creates a H application with a single window component and audio and MIDI in/out functions."); }
    ...
    bool initialiseProject (Project& project) override
    {
        ...
        String windowH = project.getFileTemplate (createCppFile ? "AudioComponentTemplate_h"
                                                                : "AudioComponentSimpleTemplate_h")
        ...
        if (createCppFile)
        {
            String windowCpp = project.getFileTemplate ("AudioComponentTemplate_cpp")
    ...
    StringArray getDefaultModules() override
    {
        ...
        s.addIfNotAlreadyThere ("audio_utils");
        return s;
    }
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (AudioAppWizard)
};
