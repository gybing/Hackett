...
struct GUIAppWizard   : public NewProjectWizard
{
    ...
    String getDescription() const override  { return TRANS("Creates a blank H application with a single window component."); }
    ...
    bool initialiseProject (Project& project) override
    {
        ...
        if (createWindow)
        {
            ...
            String windowH = project.getFileTemplate (createCppFile ? "ContentCompTemplate_h"
                                                                    : "ContentCompSimpleTemplate_h")
            ...
            if (createCppFile)
            {
                String windowCpp = project.getFileTemplate ("ContentCompTemplate_cpp")
        ...
        if (createMainCpp)
        {
            String mainCpp = project.getFileTemplate (createWindow ? "MainTemplate_Window_cpp"
                                                                   : "MainTemplate_NoWindow_cpp")
...
private:
    ...
    HDECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (GUIAppWizard)
};
