...
public:
    ...
    */
    ...
    /** Tries to connect the socket to hostname:port.
        ...
        @see isConnected
    */
    bool connect (const std::string& remoteHostname,
    ...
    */
    bool createListener (int portNumber, const std::string& localHostName = std::string());
    ...
    /** When in "listener" mode, this waits for a connection and spawns it as a new
        ...
        @see createListener
    */
    SocketTCP* waitForNextConnection() const;
...
private:
    ...
    SocketTCP (const std::string& hostname, int portNumber, int handle);
};
...
public:
    ...
    */
    SocketUDP (bool enableBroadcasting = false);
